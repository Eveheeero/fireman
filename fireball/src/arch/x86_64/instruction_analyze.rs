...
mod shortcuts {
    ...
    pub(in crate::arch) use crate::ir::low_ir::analyze::DataType;
    pub(in crate::arch) use crate::ir::low_ir::{data::*, operator::*, statements::*};
    use crate::utils::Aos;
...
use crate::{core::Instruction, ir::low_ir::statements::*};
