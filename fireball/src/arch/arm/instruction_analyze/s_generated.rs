...
pub(super) fn saba() -> &'static [IrStatement] {
    [exception("saba")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sabal() -> &'static [IrStatement] {
    [exception("sabal")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sabd() -> &'static [IrStatement] {
    [exception("sabd")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sabdl() -> &'static [IrStatement] {
    [exception("sabdl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sadalp() -> &'static [IrStatement] {
    [exception("sadalp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn saddl() -> &'static [IrStatement] {
    [exception("saddl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn saddlp() -> &'static [IrStatement] {
    [exception("saddlp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn saddlv() -> &'static [IrStatement] {
    [exception("saddlv")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn saddv() -> &'static [IrStatement] {
    [exception("saddv")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn saddw() -> &'static [IrStatement] {
    [exception("saddw")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sb() -> &'static [IrStatement] {
    [exception("sb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sbc() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn sbcs() -> &'static [IrStatement] {
    let op = b::sub(b::sub(o2(), o3()), u::not(pstate_c.clone()));
...
/// ```
#[box_to_static_reference]
pub(super) fn sbfm() -> &'static [IrStatement] {
    [exception("sbfm")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn scvtf() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn sdiv() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn sdivr() -> &'static [IrStatement] {
    [exception("sdivr")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sdot() -> &'static [IrStatement] {
    [exception("sdot")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sel() -> &'static [IrStatement] {
    [exception("sel")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn setf8() -> &'static [IrStatement] {
    let stmt_0 = assign(unknown_data(), pstate_n.clone(), size_relative(pstate_n.clone()));
    let stmt_1 = assign(unknown_data(), pstate_z.clone(), size_relative(pstate_z.clone()));
    let stmt_2 = assign(b::xor(unknown_data(), unknown_data()), pstate_v.clone(), size_relative(pstate_v.clone()));
    [stmt_0, stmt_1, stmt_2].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn setffr() -> &'static [IrStatement] {
    [exception("setffr")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sev() -> &'static [IrStatement] {
    [].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sevl() -> &'static [IrStatement] {
    [].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha1c() -> &'static [IrStatement] {
    [exception("sha1c")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha1h() -> &'static [IrStatement] {
    [exception("sha1h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha1m() -> &'static [IrStatement] {
    [exception("sha1m")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha1p() -> &'static [IrStatement] {
    [exception("sha1p")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha1su0() -> &'static [IrStatement] {
    [exception("sha1su0")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha1su1() -> &'static [IrStatement] {
    [exception("sha1su1")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha256h() -> &'static [IrStatement] {
    [exception("sha256h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha256h2() -> &'static [IrStatement] {
    [exception("sha256h2")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha256su0() -> &'static [IrStatement] {
    [exception("sha256su0")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha256su1() -> &'static [IrStatement] {
    [exception("sha256su1")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha512h() -> &'static [IrStatement] {
    [exception("sha512h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha512h2() -> &'static [IrStatement] {
    [exception("sha512h2")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha512su0() -> &'static [IrStatement] {
    [exception("sha512su0")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sha512su1() -> &'static [IrStatement] {
    [exception("sha512su1")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn shadd() -> &'static [IrStatement] {
    [exception("shadd")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn shll() -> &'static [IrStatement] {
    [exception("shll")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn shrn() -> &'static [IrStatement] {
    [exception("shrn")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn shsub() -> &'static [IrStatement] {
    [exception("shsub")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sli() -> &'static [IrStatement] {
    [exception("sli")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm3partw1() -> &'static [IrStatement] {
    [exception("sm3partw1")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm3partw2() -> &'static [IrStatement] {
    [exception("sm3partw2")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm3ss1() -> &'static [IrStatement] {
    [exception("sm3ss1")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm3tt1a() -> &'static [IrStatement] {
    [exception("sm3tt1a")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm3tt1b() -> &'static [IrStatement] {
    [exception("sm3tt1b")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm3tt2a() -> &'static [IrStatement] {
    [exception("sm3tt2a")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm3tt2b() -> &'static [IrStatement] {
    [exception("sm3tt2b")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm4e() -> &'static [IrStatement] {
    [exception("sm4e")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sm4ekey() -> &'static [IrStatement] {
    [exception("sm4ekey")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smaddl() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn smax() -> &'static [IrStatement] {
    [exception("smax")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smaxp() -> &'static [IrStatement] {
    [exception("smaxp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smaxv() -> &'static [IrStatement] {
    [exception("smaxv")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smc() -> &'static [IrStatement] {
    [exception("smc")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smin() -> &'static [IrStatement] {
    [exception("smin")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sminp() -> &'static [IrStatement] {
    [exception("sminp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sminv() -> &'static [IrStatement] {
    [exception("sminv")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smlal() -> &'static [IrStatement] {
    [exception("smlal")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smlsl() -> &'static [IrStatement] {
    [exception("smlsl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smmla() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn smov() -> &'static [IrStatement] {
    [exception("smov")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smsubl() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn smulh() -> &'static [IrStatement] {
    [exception("smulh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn smull() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn splice() -> &'static [IrStatement] {
    [exception("splice")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqabs() -> &'static [IrStatement] {
    [exception("sqabs")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqadd() -> &'static [IrStatement] {
    [exception("sqadd")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdecb() -> &'static [IrStatement] {
    [exception("sqdecb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdecd() -> &'static [IrStatement] {
    [exception("sqdecd")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdech() -> &'static [IrStatement] {
    [exception("sqdech")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdecp() -> &'static [IrStatement] {
    [exception("sqdecp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdecw() -> &'static [IrStatement] {
    [exception("sqdecw")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdmlal() -> &'static [IrStatement] {
    [exception("sqdmlal")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdmlsl() -> &'static [IrStatement] {
    [exception("sqdmlsl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdmulh() -> &'static [IrStatement] {
    [exception("sqdmulh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqdmull() -> &'static [IrStatement] {
    [exception("sqdmull")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqincb() -> &'static [IrStatement] {
    [exception("sqincb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqincd() -> &'static [IrStatement] {
    [exception("sqincd")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqinch() -> &'static [IrStatement] {
    [exception("sqinch")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqincp() -> &'static [IrStatement] {
    [exception("sqincp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqincw() -> &'static [IrStatement] {
    [exception("sqincw")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqneg() -> &'static [IrStatement] {
    [exception("sqneg")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqrdmlah() -> &'static [IrStatement] {
    [exception("sqrdmlah")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqrdmlsh() -> &'static [IrStatement] {
    [exception("sqrdmlsh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqrdmulh() -> &'static [IrStatement] {
    [exception("sqrdmulh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqrshl() -> &'static [IrStatement] {
    [exception("sqrshl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqrshrn() -> &'static [IrStatement] {
    [exception("sqrshrn")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqrshrun() -> &'static [IrStatement] {
    [exception("sqrshrun")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqshl() -> &'static [IrStatement] {
    [exception("sqshl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqshlu() -> &'static [IrStatement] {
    [exception("sqshlu")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqshrn() -> &'static [IrStatement] {
    [exception("sqshrn")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqshrun() -> &'static [IrStatement] {
    [exception("sqshrun")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqsub() -> &'static [IrStatement] {
    [exception("sqsub")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqxtn() -> &'static [IrStatement] {
    [exception("sqxtn")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sqxtun() -> &'static [IrStatement] {
    [exception("sqxtun")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn srhadd() -> &'static [IrStatement] {
    [exception("srhadd")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sri() -> &'static [IrStatement] {
    [exception("sri")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn srshl() -> &'static [IrStatement] {
    [exception("srshl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn srshr() -> &'static [IrStatement] {
    [exception("srshr")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn srsra() -> &'static [IrStatement] {
    [exception("srsra")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn ssbb() -> &'static [IrStatement] {
    [].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sshl() -> &'static [IrStatement] {
    [exception("sshl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sshll() -> &'static [IrStatement] {
    [exception("sshll")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sshr() -> &'static [IrStatement] {
    [exception("sshr")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn ssra() -> &'static [IrStatement] {
    [exception("ssra")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn ssubl() -> &'static [IrStatement] {
    [exception("ssubl")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn ssubw() -> &'static [IrStatement] {
    [exception("ssubw")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st1() -> &'static [IrStatement] {
    [exception("st1")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st1b() -> &'static [IrStatement] {
    [exception("st1b")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st1d() -> &'static [IrStatement] {
    [exception("st1d")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st1h() -> &'static [IrStatement] {
    [exception("st1h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st1w() -> &'static [IrStatement] {
    [exception("st1w")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st2() -> &'static [IrStatement] {
    [exception("st2")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st2b() -> &'static [IrStatement] {
    [exception("st2b")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st2d() -> &'static [IrStatement] {
    [exception("st2d")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st2g() -> &'static [IrStatement] {
    [exception("st2g")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st2h() -> &'static [IrStatement] {
    [exception("st2h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st2w() -> &'static [IrStatement] {
    [exception("st2w")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st3() -> &'static [IrStatement] {
    [exception("st3")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st3b() -> &'static [IrStatement] {
    [exception("st3b")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st3d() -> &'static [IrStatement] {
    [exception("st3d")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st3h() -> &'static [IrStatement] {
    [exception("st3h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st3w() -> &'static [IrStatement] {
    [exception("st3w")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st4() -> &'static [IrStatement] {
    [exception("st4")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st4b() -> &'static [IrStatement] {
    [exception("st4b")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st4d() -> &'static [IrStatement] {
    [exception("st4d")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st4h() -> &'static [IrStatement] {
    [exception("st4h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn st4w() -> &'static [IrStatement] {
    [exception("st4w")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stg() -> &'static [IrStatement] {
    [exception("stg")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stgm() -> &'static [IrStatement] {
    [exception("stgm")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stgp() -> &'static [IrStatement] {
    [exception("stgp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stllr() -> &'static [IrStatement] {
    [exception("stllr")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stllrb() -> &'static [IrStatement] {
    [exception("stllrb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stllrh() -> &'static [IrStatement] {
    [exception("stllrh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlr() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn stlrb() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlrh() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlur() -> &'static [IrStatement] {
    [exception("stlur")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlurb() -> &'static [IrStatement] {
    [exception("stlurb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlurh() -> &'static [IrStatement] {
    [exception("stlurh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlxp() -> &'static [IrStatement] {
    [exception("stlxp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlxr() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlxrb() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stlxrh() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stnp() -> &'static [IrStatement] {
    [exception("stnp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stnt1b() -> &'static [IrStatement] {
    [exception("stnt1b")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stnt1d() -> &'static [IrStatement] {
    [exception("stnt1d")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stnt1h() -> &'static [IrStatement] {
    [exception("stnt1h")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stnt1w() -> &'static [IrStatement] {
    [exception("stnt1w")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stp() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn strb() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn strh() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sttr() -> &'static [IrStatement] {
    [exception("sttr")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sttrb() -> &'static [IrStatement] {
    [exception("sttrb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sttrh() -> &'static [IrStatement] {
    [exception("sttrh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stur() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sturb() -> &'static [IrStatement] {
    [exception("sturb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sturh() -> &'static [IrStatement] {
    [exception("sturh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stxp() -> &'static [IrStatement] {
    [exception("stxp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stxr() -> &'static [IrStatement] {
    let assignment = assign(o1(), o2(), o2_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stxrb() -> &'static [IrStatement] {
    [exception("stxrb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stxrh() -> &'static [IrStatement] {
    [exception("stxrh")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stz2g() -> &'static [IrStatement] {
    [exception("stz2g")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stzg() -> &'static [IrStatement] {
    [exception("stzg")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn stzgm() -> &'static [IrStatement] {
    [exception("stzgm")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn subg() -> &'static [IrStatement] {
    [exception("subg")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn subhn() -> &'static [IrStatement] {
    [exception("subhn")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn subp() -> &'static [IrStatement] {
    let assignment = assign(b::sub(o2(), o3()), o1(), o1_size());
    [assignment].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn subr() -> &'static [IrStatement] {
    [exception("subr")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn subs() -> &'static [IrStatement] {
    let op = b::sub(o2(), o3());
    let assignment = assign(op.clone(), o1(), o1_size());
    let calc_flags = calc_flags_automatically(op, o1_size(), &[&pstate_n, &pstate_z, &pstate_c, &pstate_v]);
    [calc_flags, assignment].into()
...
/// ```
#[box_to_static_reference]
pub(super) fn sudot() -> &'static [IrStatement] {
    [exception("sudot")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sunpkhi() -> &'static [IrStatement] {
    [exception("sunpkhi")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn suqadd() -> &'static [IrStatement] {
    [exception("suqadd")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn svc() -> &'static [IrStatement] {
    [exception("svc")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn swp() -> &'static [IrStatement] {
    [exception("swp")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn swpb() -> &'static [IrStatement] {
    [exception("swpb")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn swph() -> &'static [IrStatement] {
    [exception("swph")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sxtb() -> &'static [IrStatement] {
...
/// ```
#[box_to_static_reference]
pub(super) fn sys() -> &'static [IrStatement] {
    [exception("sys")].into()
}
...
/// ```
#[box_to_static_reference]
pub(super) fn sysl() -> &'static [IrStatement] {
    [exception("sysl")].into()
}
...
///         match = FALSE;
/// 
///     return match;// AArch32.SelfHostedSecurePrivilegedInvasiveDebugEnabled()
/// // ========================================================
/// 
...
///     return DBGEN == HIGH && SPIDEN == HIGH;// AArch32.BreakpointMatch()
/// // =========================
...
/// 
///     return (match, mismatch);// AArch32.BreakpointValueMatch()
/// // ==============================
...
/// 
///     return (match && !mismatch, !match && mismatch);// AArch32.StateMatch()
/// // ====================
...
/// 
///     return priv_match && security_state_match && (!linked || linked_match);// AArch32.GenerateDebugExceptions()
/// // =================================
/// 
/// boolean AArch32.GenerateDebugExceptions()
///     return AArch32.GenerateDebugExceptionsFrom(PSTATE.EL, IsSecure());// AArch32.GenerateDebugExceptionsFrom()
/// // =====================================
/// 
...
///         enabled = from != EL2;
/// 
///     return enabled;// AArch32.CheckForPMUOverflow()
/// // =============================
...
/// 
///     return pmuirq;// AArch32.CountEvents()
/// // =====================
...
/// 
///     return !debug && enabled && !prohibited && !filtered;// AArch32.EnterHypModeInDebugState()
/// // ==================================
...
///     UpdateEDSCRFields();
/// 
///     EndOfInstruction();// AArch32.EnterModeInDebugState()
/// // ===============================
...
/// 
///     EndOfInstruction();// AArch32.EnterMonitorModeInDebugState()
/// // ======================================
...
///     UpdateEDSCRFields();                        // Update EDSCR processor state flags.
/// 
///     EndOfInstruction();// AArch32.WatchpointByteMatch()
/// // =============================
/// 
...
/// 
///     return WVR_match && byte_select_match;// AArch32.WatchpointMatch()
/// // =========================
...
/// 
///     return value_match && state_match && ls_match && enabled;// AArch32.Abort()
/// // ===============
...
///     else
///         AArch32.TakeDataAbortException(vaddress, fault);// AArch32.AbortSyndrome()
/// // =======================
...
/// 
///     return exception;// AArch32.CheckPCAlignment()
/// // ==========================
/// 
...
///         iswrite = FALSE;
///         secondstage = FALSE;
///         AArch32.Abort(vaddress, AArch32.AlignmentFault(acctype, iswrite, secondstage));// AArch32.ReportDataAbort()
/// // =========================
...
///         DFAR = vaddress;
/// 
///     return;// AArch32.ReportPrefetchAbort()
/// // =============================
/// // Report syndrome information for aborts taken to modes other than Hyp mode.
/// 
...
///         IFAR = vaddress;
/// 
///     return;// AArch32.TakeDataAbortException()
/// // ================================
/// 
...
///     else
///         AArch32.ReportDataAbort(route_to_monitor, fault, vaddress);
///         AArch32.EnterMode(M32_Abort, preferred_exception_return, lr_offset, vect_offset);// AArch32.TakePrefetchAbortException()
/// // ====================================
/// 
...
///     else
///         AArch32.ReportPrefetchAbort(route_to_monitor, fault, vaddress);
///         AArch32.EnterMode(M32_Abort, preferred_exception_return, lr_offset, vect_offset);// BranchTargetException
/// // =====================
...
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch32.TakePhysicalFIQException()
/// // ==================================
/// 
...
///         AArch32.EnterHypMode(exception, preferred_exception_return, vect_offset);
///     else
///         AArch32.EnterMode(M32_FIQ, preferred_exception_return, lr_offset, vect_offset);// AArch32.TakePhysicalIRQException()
/// // ==================================
...
///         AArch32.EnterHypMode(exception, preferred_exception_return, vect_offset);
///     else
///         AArch32.EnterMode(M32_IRQ, preferred_exception_return, lr_offset, vect_offset);// AArch32.TakePhysicalSErrorException()
/// // =====================================
/// 
...
///     else
///         AArch32.ReportDataAbort(route_to_monitor, fault, vaddress);
///         AArch32.EnterMode(M32_Abort, preferred_exception_return, lr_offset, vect_offset);// AArch32.TakeVirtualFIQException()
/// // =================================
/// 
...
///     lr_offset = 4;
/// 
///     AArch32.EnterMode(M32_FIQ, preferred_exception_return, lr_offset, vect_offset);// AArch32.TakeVirtualIRQException()
/// // =================================
/// 
...
///     lr_offset = 4;
/// 
///     AArch32.EnterMode(M32_IRQ, preferred_exception_return, lr_offset, vect_offset);// AArch32.TakeVirtualSErrorException()
/// // ====================================
/// 
...
///     AArch32.ReportDataAbort(route_to_monitor, fault, vaddress);
///     AArch32.EnterMode(M32_Abort, preferred_exception_return, lr_offset, vect_offset);// AArch32.SoftwareBreakpoint()
/// // ============================
/// 
...
///     AArch32.Abort(vaddress, fault);constant bits(4) DebugException_Breakpoint  = '0001';
/// constant bits(4) DebugException_BKPT        = '0011';
/// constant bits(4) DebugException_VectorCatch = '0101';
/// constant bits(4) DebugException_Watchpoint  = '1010';// AArch32.CheckAdvSIMDOrFPRegisterTraps()
/// // =======================================
...
///             else
///                 AArch64.AArch32SystemAccessTrap(EL2, 0x8);            // Exception_AdvSIMDFPAccessTrap// AArch32.ExceptionClass()
/// // ========================
...
///         ec = ec + 1;
/// 
///     return (ec,il);// AArch32.GeneralExceptionsToAArch64()
/// // ====================================
...
///             (EL2Enabled() && !ELUsingAArch32(EL2) && HCR_EL2.TGE == '1'));// AArch32.ReportHypEntry()
/// // ========================
...
/// 
///     return;// Resets System registers and memory-mapped control registers that have architecturally-defined
/// // reset values to those values.
/// AArch32.ResetControlRegisters(boolean cold_reset);// AArch32.TakeReset()
/// // ===================
...
/// 
///     BranchTo(rv, BranchType_RESET);// ExcVectorBase()
/// // ===============
/// 
...
///     else
///         return VBAR<31:5>:Zeros(5);// AArch32.FPTrappedException()
/// // ============================
/// 
...
/// 
///     AArch32.TakeUndefInstrException();// AArch32.CallHypervisor()
/// // ========================
/// // Performs a HVC call
/// 
...
///     else
///         AArch32.TakeHVCException(immediate);// AArch32.CallSupervisor()
/// // ========================
...
///     else
///         AArch32.TakeSVCException(immediate);// AArch32.TakeHVCException()
/// // ==========================
/// 
...
///         AArch32.EnterHypMode(exception, preferred_exception_return, vect_offset);
///     else
///         AArch32.EnterHypMode(exception, preferred_exception_return, 0x14);// AArch32.TakeSMCException()
/// // ==========================
/// 
...
///     lr_offset = 0;
/// 
///     AArch32.EnterMonitorMode(preferred_exception_return, lr_offset, vect_offset);// AArch32.TakeSVCException()
/// // ==========================
/// 
...
///             AArch32.EnterHypMode(exception, preferred_exception_return, 0x14);
///     else
///         AArch32.EnterMode(M32_Svc, preferred_exception_return, lr_offset, vect_offset);// AArch32.EnterHypMode()
/// // ======================
...
/// 
///     EndOfInstruction();// AArch32.EnterMode()
/// // ===================
...
/// 
///     EndOfInstruction();// AArch32.EnterMonitorMode()
/// // ==========================
...
/// 
///     EndOfInstruction();// AArch32.CheckAdvSIMDOrFPEnabled()
/// // =================================
...
/// 
///         AArch32.CheckFPAdvSIMDTrap(advsimd);    // Also check against HCPTR and CPTR_EL3// AArch32.CheckFPAdvSIMDTrap()
/// // ============================
...
///     return;// AArch32.CheckForSMCUndefOrTrap()
/// // ================================
...
///             AArch32.TakeHypTrapException(exception);// AArch32.CheckForSVCTrap()
/// // =========================
...
///             vect_offset = 0x0;
/// 
///             AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);// AArch32.CheckForWFxTrap()
/// // =========================
...
///             AArch32.TakeHypTrapException(exception);
///         else
///             AArch32.TakeUndefInstrException();// AArch32.CheckITEnabled()
/// // ========================
...
///             UNDEFINED;
/// 
///     return;// AArch32.CheckIllegalState()
/// // ===========================
...
///                 AArch32.EnterHypMode(exception, preferred_exception_return, 0x14);
///         else
///             AArch32.TakeUndefInstrException();// AArch32.CheckSETENDEnabled()
/// // ============================
...
///         UNDEFINED;
/// 
///     return;// AArch32.SystemAccessTrap()
/// // ==========================
...
///         AArch32.TakeHypTrapException(exception);
///     else
///         AArch32.TakeUndefInstrException();// AArch32.SystemAccessTrapSyndrome()
/// // ==================================
...
/// 
///     return exception;// AArch32.TakeHypTrapException()
/// // ==============================
...
///     vect_offset = 0x14;
/// 
///     AArch32.EnterHypMode(exception, preferred_exception_return, vect_offset);// AArch32.TakeMonitorTrapException()
/// // ==================================
...
/// 
///     AArch32.EnterMonitorMode(preferred_exception_return, lr_offset, vect_offset);// AArch32.TakeUndefInstrException()
/// // =================================
/// 
...
///         AArch32.EnterHypMode(exception, preferred_exception_return, 0x14);
///     else
///         AArch32.EnterMode(M32_Undef, preferred_exception_return, lr_offset, vect_offset);// AArch32.UndefinedFault()
/// // ========================
/// 
/// AArch32.UndefinedFault()
/// 
///     if AArch32.GeneralExceptionsToAArch64() then AArch64.UndefinedFault();
///     AArch32.TakeUndefInstrException();// AArch32.CreateFaultRecord()
/// // ===========================
/// 
...
/// 
///     return fault;// AArch32.DomainValid()
/// // =====================
...
///             return level == 2;
///         otherwise
///             return FALSE;// AArch32.FaultStatusLD()
/// // =======================
...
/// 
///     return fsr;// AArch32.FaultStatusSD()
/// // =======================
/// // Creates an exception fault status value for Abort and Watchpoint exceptions taken
...
/// 
///     return fsr;// AArch32.FaultSyndrome()
/// // =======================
...
/// 
///     return (imm32, carry_out);// DecodeImmShift()
/// // ================
/// 
...
/// 
///     return (shift_t, shift_n);// DecodeRegShift()
/// // ================
/// 
...
///     carry_out = x<0>;
///     return (result, carry_out);enumeration SRType {SRType_LSL, SRType_LSR, SRType_ASR, SRType_ROR, SRType_RRX};// Shift()
/// // =======
/// 
/// bits(N) Shift(bits(N) value, SRType srtype, integer amount, bit carry_in)
///     (result, -) = Shift_C(value, srtype, amount, carry_in);
///     return result;// Shift_C()
/// // =========
/// 
...
/// 
///     return (result, carry_out);// T32ExpandImm()
/// // ==============
/// 
...
/// 
///     return (imm32, carry_out);// AArch32.CheckCP15InstrCoarseTraps()
/// // ===================================
...
///             return TRUE;
/// 
///     return FALSE;// AArch32.ExclusiveMonitorsPass()
/// // ===============================
/// 
...
/// 
///     return passed;// An optional IMPLEMENTATION DEFINED test for an exclusive access to a virtual
...
/// boolean AArch32.IsExclusiveVA(bits(32) address, integer processorid, integer size);// Optionally record an exclusive access to the virtual address region of size bytes
/// // starting at address for processorid.
/// AArch32.MarkExclusiveVA(bits(32) address, integer processorid, integer size);// AArch32.SetExclusiveMonitors()
/// // ==============================
/// 
...
/// 
///     AArch32.MarkExclusiveVA(address, ProcessorID(), size);// CheckAdvSIMDEnabled()
/// // =====================
/// 
/// CheckAdvSIMDEnabled()
/// 
...
///     return result;// StandardFPSCRValue()
/// // ====================
/// 
/// FPCRType StandardFPSCRValue()
///     return '00000' : FPSCR.AHP : '110000' : FPSCR.FZ16 : '0000000000000000000';// AArch32.CheckAlignment()
/// // ========================
/// 
...
/// 
///     return aligned;// AArch32.MemSingle[] - non-assignment (read) form
/// // ================================================
...
///     return;Hint_PreloadData(bits(32) address);Hint_PreloadDataForWrite(bits(32) address);Hint_PreloadInstr(bits(32) address);// MemA[] - non-assignment form
/// // ============================
/// 
...
///     return;// MemO[] - non-assignment form
/// // ============================
/// 
...
///     acctype = AccType_ORDERED;
///     Mem_with_type[address, size, acctype] = value;
///     return;// MemU[] - non-assignment form
/// // ============================
/// 
...
///     acctype = AccType_NORMAL;
///     Mem_with_type[address, size, acctype] = value;
///     return;// MemU_unpriv[] - non-assignment form
/// // ===================================
/// 
...
///     acctype = AccType_UNPRIV;
///     Mem_with_type[address, size, acctype] = value;
///     return;// Mem_with_type[] - non-assignment (read) form
/// // ============================================
...
///         ClearPendingPhysicalSError();
/// 
///     return;// Return the SError syndrome
/// AArch32.SErrorSyndrome AArch32.PhysicalSErrorSyndrome();// AArch32.ReportDeferredSError()
/// // ==============================
...
///     return target;type AArch32.SErrorSyndrome is (
///     bits(2) AET,
///     bit ExT
...
/// 
///     return;// AArch32.ResetGeneralRegisters()
/// // ===============================
/// 
/// AArch32.ResetGeneralRegisters()
/// 
...
/// 
///     return;// AArch32.ResetSIMDFPRegisters()
/// // ==============================
/// 
/// AArch32.ResetSIMDFPRegisters()
/// 
...
/// 
///     return;// AArch32.ResetSpecialRegisters()
/// // ===============================
/// 
/// AArch32.ResetSpecialRegisters()
/// 
...
///     DSPSR = bits(32) UNKNOWN;
/// 
///     return;AArch32.ResetSystemRegisters(boolean cold_reset);// ALUExceptionReturn()
/// // ====================
/// 
...
///     else
///         AArch32.ExceptionReturn(address, SPSR[]);// ALUWritePC()
/// // ============
/// 
...
///     else
///         BranchWritePC(address, BranchType_INDIR);// BXWritePC()
/// // ===========
/// 
...
///             address<1> = '0';
///     BranchTo(address, branch_type);// BranchWritePC()
/// // ===============
/// 
...
///     else
///         address<0> = '0';
///     BranchTo(address, branch_type);// D[] - non-assignment form
/// // =========================
/// 
/// bits(64) D[integer n]
///     assert n >= 0 && n <= 31;
...
///     V[n DIV 2] = vreg;
///     return;// Din[] - non-assignment form
/// // ===========================
/// 
/// bits(64) Din[integer n]
///     assert n >= 0 && n <= 31;
///     return _Dclone[n];// LR - assignment form
/// // ====================
/// 
/// LR = bits(32) value
///     R[14] = value;
...
/// 
/// bits(32) LR
///     return R[14];// LoadWritePC()
/// // =============
/// 
/// LoadWritePC(bits(32) address)
///     BXWritePC(address, BranchType_INDIR);// LookUpRIndex()
/// // ==============
/// 
...
///         otherwise  result = n;
/// 
///     return result;bits(32) SP_mon;
/// bits(32) LR_mon;// PC - non-assignment form
/// // ========================
/// 
/// bits(32) PC
///     return R[15];               // This includes the offset from AArch32 state// PCStoreValue()
/// // ==============
/// 
...
///     return PC;// Q[] - non-assignment form
/// // =========================
/// 
...
///     assert n >= 0 && n <= 15;
///     V[n] = value;
///     return;// Qin[] - non-assignment form
/// // ===========================
/// 
/// bits(128) Qin[integer n]
///     assert n >= 0 && n <= 15;
///     return Din[2*n+1]:Din[2*n];// R[] - assignment form
/// // =====================
/// 
...
///     else
///         return Rmode[n, PSTATE.M];// RBankSelect()
/// // =============
/// 
...
/// 
///     return result;// Rmode[] - non-assignment form
/// // =============================
/// 
...
/// 
/// bits(32) SP
///     return R[13];array bits(64) _Dclone[0..31];// AArch32.ExceptionReturn()
/// // =========================
/// 
...
///             new_pc<1:0> = '00';              // A32
/// 
///     BranchTo(new_pc, BranchType_ERET);// AArch32.ExecutingATS1xPInstr()
/// // ==============================
...
///     else
///         return FALSE;// AArch32.ExecutingCP10or11Instr()
/// // ================================
/// 
...
///     else // InstrSet_T32
///         return (instr<31:28> == '111x' && (instr<27:24> == '1110' || instr<27:25> == '110') && instr<11:8> == '101x');// AArch32.ExecutingLSMInstr()
/// // ===========================
...
///         else
///             return (instr<25+:7> == '1110100' && instr<22> == '0');// AArch32.ITAdvance()
/// // ===================
/// 
/// AArch32.ITAdvance()
...
///     return;// Read from a 32-bit AArch32 System register and return the register's contents.
/// bits(32) AArch32.SysRegRead(integer cp_num, bits(32) instr);// Read from a 64-bit AArch32 System register and return the register's contents.
/// bits(64) AArch32.SysRegRead64(integer cp_num, bits(32) instr);// AArch32.SysRegReadCanWriteAPSR()
/// // ================================
...
///         return TRUE;
/// 
///     return FALSE;// Write to a 32-bit AArch32 System register.
/// AArch32.SysRegWrite(integer cp_num, bits(32) instr, bits(32) val);// Write to a 64-bit AArch32 System register.
/// AArch32.SysRegWrite64(integer cp_num, bits(32) instr, bits(64) val);// AArch32.WriteMode()
/// // ===================
...
///     return;// AArch32.WriteModeByInstr()
/// // ==========================
...
///         PSTATE.IL = '1';
///     else
///         AArch32.WriteMode(mode);// BadMode()
/// // =========
/// 
...
///     return !valid;// BankedRegisterAccessValid()
/// // ===========================
...
///     return ConditionHolds(AArch32.CurrentCond());bits(4) AArch32.CurrentCond();// InITBlock()
/// // ===========
/// 
/// boolean InITBlock()
...
///     else
///         return FALSE;// LastInITBlock()
/// // ===============
/// 
/// boolean LastInITBlock()
///     return (PSTATE.IT<3:0> == '1000');// SPSRWriteByInstr()
/// // ==================
/// 
...
/// 
///     return result;// AArch32.DefaultTEXDecode()
/// // ==========================
/// 
...
/// 
///     return MemAttrDefaults(memattrs);// AArch32.InstructionDevice()
/// // ===========================
...
/// 
///     return addrdesc;// AArch32.RemappedTEXDecode()
/// // ===========================
/// 
...
///     memattrs.tagged = FALSE;
/// 
///     return MemAttrDefaults(memattrs);// AArch32.S1AttrDecode()
/// // ======================
...
/// 
///     return MemAttrDefaults(memattrs);// AArch32.TranslateAddressS1Off()
/// // ===============================
...
///     return result;// AArch32.AccessIsPrivileged()
/// // ============================
/// 
...
/// 
///     return ispriv;// AArch32.AccessUsesEL()
/// // ======================
...
///         return EL0;
///     else
///         return PSTATE.EL;// AArch32.CheckDomain()
/// // =====================
/// 
...
/// 
///     return (permissioncheck, fault);// AArch32.CheckPermission()
/// // =========================
...
///     else
///         return AArch32.NoFault();// AArch32.CheckS2Permission()
/// // ===========================
...
///                                        !failedread, secondstage, s2fs1walk);
///     else
///         return AArch32.NoFault();// AArch32.CheckBreakpoint()
/// // =========================
...
///     else
///         return AArch32.NoFault();// AArch32.CheckDebug()
/// // ====================
...
/// 
///     return fault;// AArch32.CheckVectorCatch()
/// // ==========================
/// // Called before executing the instruction of length "size" bytes at "vaddress" in an AArch32
...
///         return AArch32.DebugFault(acctype, iswrite, debugmoe);
///     else
///         return AArch32.NoFault();// AArch32.CheckWatchpoint()
/// // =========================
...
///         return AArch32.DebugFault(acctype, iswrite, debugmoe);
///     else
///         return AArch32.NoFault();// AArch32.AccessFlagFault()
/// // =========================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.AddressSizeFault()
/// // ==========================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.AlignmentFault()
/// // ========================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.AsynchExternalAbort()
/// // =============================
...
///                                      debugmoe,  errortype, secondstage, s2fs1walk);// AArch32.DebugFault()
/// // ====================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.DomainFault()
/// // =====================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.NoFault()
/// // =================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.PermissionFault()
/// // =========================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.TranslationFault()
/// // ==========================
/// 
...
///                                      extflag, debugmoe, errortype, secondstage, s2fs1walk);// AArch32.FirstStageTranslate()
/// // =============================
...
///                                         secondstage, s2fs1walk);
/// 
///     return S1.addrdesc;// AArch32.FullTranslate()
/// // =======================
...
///         result = S1;
/// 
///     return result;// AArch32.SecondStageTranslate()
/// // ==============================
...
///         result = S1;
/// 
///     return result;// AArch32.SecondStageWalk()
/// // =========================
...
/// 
///     return result;// AArch32.TranslationTableWalkLD()
/// // ================================
...
/// 
///     return result;// AArch32.TranslationTableWalkSD()
/// // ================================
...
///     result.addrdesc.fault = AArch32.NoFault();
/// 
///     return result;boolean RemapRegsHaveResetValues();// AArch64.BreakpointMatch()
/// // =========================
...
///     match = value_match && state_match && enabled;
/// 
///     return match;// AArch64.BreakpointValueMatch()
/// // ==============================
/// 
...
///     match = (!bxvr_match_valid || BXVR_match) && (!bvr_match_valid || BVR_match);
/// 
///     return match;// AArch64.StateMatch()
/// // ====================
/// // Determine whether a breakpoint or watchpoint is enabled in the current mode and state.
/// 
...
/// 
///     return priv_match && security_state_match && (!linked || linked_match);// AArch64.GenerateDebugExceptions()
/// // =================================
/// 
/// boolean AArch64.GenerateDebugExceptions()
///     return AArch64.GenerateDebugExceptionsFrom(PSTATE.EL, IsSecure(), PSTATE.D);// AArch64.GenerateDebugExceptionsFrom()
/// // =====================================
/// 
...
/// 
///     return enabled;// AArch64.CheckForPMUOverflow()
/// // =============================
/// // Signal Performance Monitors overflow IRQ and CTI overflow events
/// 
...
///     // or cross-triggered event handler clears the overflow status flag by writing to PMOVSCLR_EL0.)
/// 
///     return pmuirq;// AArch64.CountEvents()
/// // =====================
/// // Return TRUE if counter "n" should count its event. For the cycle counter, n == 31.
/// 
...
/// 
///     return !debug && enabled && !prohibited && !filtered;// CheckProfilingBufferAccess()
/// // ============================
/// 
...
/// 
///     return SysRegAccess_OK;// CheckStatisticalProfilingAccess()
/// // =================================
/// 
...
///         return SysRegAccess_TrapToEL3;
/// 
///     return SysRegAccess_OK;// CollectContextIDR1()
/// // ====================
/// 
...
///     return PMSCR_EL1.CX == '1';// CollectContextIDR2()
/// // ====================
/// 
/// boolean CollectContextIDR2()
///     if !StatisticalProfilingEnabled() then return FALSE;
///     if  EL2Enabled() then return FALSE;
///     return PMSCR_EL2.CX == '1';// CollectPhysicalAddress()
/// // ========================
/// 
...
///     else
///         return PMSCR_EL1.PA == '1';// CollectRecord()
/// // ===============
/// 
...
///     return (if pct then TimeStamp_Physical else TimeStamp_Virtual);enumeration OpType {
...
///             PMBLIMITR_EL1.E == '1' && PMBSR_EL1.S == '0');// ProfilingBufferOwner()
/// // ======================
/// 
...
///     return (secure, el);// Barrier to ensure that all existing profiling data has been formatted, and profiling buffer
...
/// ProfilingSynchronizationBarrier();// StatisticalProfilingEnabled()
/// // =============================
/// 
...
/// 
///     return spe_bit == '1';enumeration SysRegAccess { SysRegAccess_OK,
///                            SysRegAccess_UNDEFINED,
///                            SysRegAccess_TrapToEL1,
///                            SysRegAccess_TrapToEL2,
///                            SysRegAccess_TrapToEL3 };enumeration TimeStamp {
...
///     TimeStamp_Physical };  // Physical counter value with no offset// AArch64.TakeExceptionInDebugState()
/// // ===================================
...
///         SynchronizeErrors();
/// 
///     EndOfInstruction();// AArch64.WatchpointByteMatch()
/// // =============================
/// 
...
/// 
///     return WVR_match && byte_select_match;// AArch64.WatchpointMatch()
/// // =========================
...
/// 
///     return value_match && state_match && ls_match && enabled;// AArch64.Abort()
/// // ===============
...
///     else
///         AArch64.DataAbort(vaddress, fault);// AArch64.AbortSyndrome()
/// // =======================
...
///         exception.ipavalid = FALSE;
/// 
///     return exception;// AArch64.CheckPCAlignment()
/// // ==========================
/// 
...
///     if pc<1:0> != '00' then
///         AArch64.PCAlignmentFault();// AArch64.DataAbort()
/// // ===================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.EffectiveTCF()
/// // ======================
...
/// 
///     return tcf;// AArch64.InstructionAbort()
/// // ==========================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.PCAlignmentFault()
/// // ==========================
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.ReportTagCheckFail()
/// // ============================
...
///             TFSRE0_EL1.TF0 = '1';
///         else
///             TFSRE0_EL1.TF1 = '1';// AArch64.SPAlignmentFault()
/// // ==========================
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TagCheckFail()
/// // ======================
...
///     elsif tcf == '10' then
///         AArch64.ReportTagCheckFail(PSTATE.EL, vaddress<55>);// AArch64.TagCheckFault()
/// // =======================
...
/// 
///     AArch64.TakeException(target_el, exception, preferred_exception_return, vect_offset);// BranchTargetException
/// // =====================
/// // Raise branch target exception.
/// 
/// AArch64.BranchTargetException(bits(52) vaddress)
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TakePhysicalFIQException()
/// // ==================================
/// 
...
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TakePhysicalIRQException()
/// // ==================================
/// // Take an enabled physical IRQ exception.
/// 
...
///     else
///         assert PSTATE.EL IN {EL0, EL1};
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TakePhysicalSErrorException()
/// // =====================================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TakeVirtualFIQException()
/// // =================================
/// 
...
///     exception = ExceptionSyndrome(Exception_FIQ);
/// 
///     AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TakeVirtualIRQException()
/// // =================================
/// 
...
///     exception = ExceptionSyndrome(Exception_IRQ);
/// 
///     AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TakeVirtualSErrorException()
/// // ====================================
/// 
...
/// 
///     ClearPendingVirtualSError();
///     AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.BreakpointException()
/// // =============================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.SoftwareBreakpoint()
/// // ============================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.SoftwareStepException()
/// // ===============================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.VectorCatchException()
/// // ==============================
...
/// 
///     AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);// AArch64.WatchpointException()
/// // =============================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.ExceptionClass()
/// // ========================
...
///         ec = ec + 4;
/// 
///     return (ec,il);// AArch64.ReportException()
/// // =========================
...
///     return;// Resets System registers and memory-mapped control registers that have architecturally-defined
/// // reset values to those values.
/// AArch64.ResetControlRegisters(boolean cold_reset);// AArch64.TakeReset()
/// // ===================
...
/// 
///     BranchTo(rv, BranchType_RESET);// AArch64.FPTrappedException()
/// // ============================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.CallHypervisor()
/// // ========================
/// // Performs a HVC call
/// 
...
///         AArch64.TakeException(EL3, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);// AArch64.CallSecureMonitor()
/// // ===========================
/// 
...
///     exception.syndrome<15:0> = immediate;
/// 
///     AArch64.TakeException(EL3, exception, preferred_exception_return, vect_offset);// AArch64.CallSupervisor()
/// // ========================
/// // Calls the Supervisor
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.TakeException()
/// // =======================
...
///         TakeUnmaskedPhysicalSErrorInterrupts(iesb_req);
/// 
///     EndOfInstruction();// AArch64.AArch32SystemAccessTrap()
/// // =================================
...
///     AArch64.TakeException(target_el, exception, preferred_exception_return, vect_offset);// AArch64.AArch32SystemAccessTrapSyndrome()
/// // =========================================
/// // Returns the syndrome information for traps on AArch32 MCR, MCRR, MRC, MRRC, and VMRS, VMSR instructions,
/// // other than traps that are due to HCPTR or CPACR.
/// 
...
///     exception.syndrome<19:0>  = iss;
/// 
///     return exception;// AArch64.AdvSIMDFPAccessTrap()
/// // =============================
...
/// 
///     return;// AArch64.CheckCP15InstrCoarseTraps()
/// // ===================================
...
///             return TRUE;
/// 
///     return FALSE;// AArch64.CheckFPAdvSIMDEnabled()
/// // ===============================
/// // Check against CPACR[]
/// 
/// AArch64.CheckFPAdvSIMDEnabled()
...
/// 
///     AArch64.CheckFPAdvSIMDTrap();               // Also check against CPTR_EL2 and CPTR_EL3// AArch64.CheckFPAdvSIMDTrap()
/// // ============================
/// // Check against CPTR_EL2 and CPTR_EL3.
/// 
/// AArch64.CheckFPAdvSIMDTrap()
...
///         if CPTR_EL3.TFP == '1' then AArch64.AdvSIMDFPAccessTrap(EL3);
/// 
///     return;// AArch64.CheckForERetTrap()
/// // ==========================
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);// AArch64.CheckForSMCUndefOrTrap()
/// // ================================
/// // Check for UNDEFINED or trap on SMC instruction
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);// AArch64.CheckForSVCTrap()
/// // =========================
/// // Check for trap on SVC instruction
/// 
...
///             vect_offset = 0x0;
/// 
///             AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);// AArch64.CheckForWFxTrap()
/// // =========================
/// // Check for trap on WFE or WFI instruction
/// 
...
///     if trap then
///         AArch64.WFxTrap(target_el, is_wfe);// AArch64.CheckIllegalState()
/// // ===========================
/// // Check PSTATE.IL bit and generate Illegal Execution state exception if set.
/// 
/// AArch64.CheckIllegalState()
...
///             AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///         else
///             AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.MonitorModeTrap()
/// // =========================
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     AArch64.TakeException(EL3, exception, preferred_exception_return, vect_offset);// AArch64.SystemAccessTrap()
/// // ==========================
...
///     AArch64.TakeException(target_el, exception, preferred_exception_return, vect_offset);// AArch64.SystemAccessTrapSyndrome()
/// // ==================================
...
///             Unreachable();
/// 
///     return exception;// AArch64.UndefinedFault()
/// // ========================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// AArch64.WFxTrap()
/// // =================
/// 
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(target_el, exception, preferred_exception_return, vect_offset);// CheckFPAdvSIMDEnabled64()
/// // =========================
/// // AArch64 instruction wrapper
/// 
/// CheckFPAdvSIMDEnabled64()
///     AArch64.CheckFPAdvSIMDEnabled();// AArch64.CreateFaultRecord()
/// // ===========================
/// 
...
///     fault.s2fs1walk = s2fs1walk;
/// 
///     return fault;// AArch64.FaultSyndrome()
/// // =======================
/// // Creates an exception syndrome value for Abort and Watchpoint exceptions taken to
...
///     iss<5:0> = EncodeLDFSC(fault.statuscode, fault.level);
/// 
///     return iss;// AArch64.ExclusiveMonitorsPass()
/// // ===============================
/// 
/// // Return TRUE if the Exclusives monitors for the current PE include all of the addresses
/// // associated with the virtual address region of size bytes starting at address.
...
/// //
/// // It is always safe to return TRUE which will check the physical address only.
/// boolean AArch64.IsExclusiveVA(bits(64) address, integer processorid, integer size);// Optionally record an exclusive access to the virtual address region of size bytes
/// // starting at address for processorid.
/// AArch64.MarkExclusiveVA(bits(64) address, integer processorid, integer size);// AArch64.SetExclusiveMonitors()
/// // ==============================
/// 
/// // Sets the Exclusives monitors for the current PE to record the addresses associated
/// // with the virtual address region of size bytes starting at address.
...
///     MarkExclusiveLocal(memaddrdesc.paddress, ProcessorID(), size);
/// 
///     AArch64.MarkExclusiveVA(address, ProcessorID(), size);// FPRSqrtStepFused()
/// // ==================
/// 
...
///             else
///                 result = FPRound(result_value, FPCR);
///     return result;// FPRecipStepFused()
/// // ==================
/// 
...
///             else
///                 result = FPRound(result_value, FPCR);
///     return result;// AArch64.AccessIsTagChecked()
/// // ============================
...
///         return FALSE;
/// 
///     return TRUE;// AArch64.AddressWithAllocationTag()
/// // ==================================
...
///         tag = '0000';
///     result<59:56> = tag;
///     return result;// AArch64.AllocationTagFromAddress()
/// // ==================================
...
///     return tagged_address<59:56>;// AArch64.CheckAlignment()
/// // ========================
/// 
...
///         AArch64.Abort(address, AArch64.AlignmentFault(acctype, iswrite, secondstage));
/// 
///     return aligned;// AArch64.CheckTag()
/// // ==================
...
///     else
///         return TRUE;// AArch64.MemSingle[] - non-assignment (read) form
/// // ================================================
/// // Perform an atomic, little-endian read of 'size' bytes.
/// 
...
///                 AArch64.TagCheckFail(ZeroExtend(address, 64), iswrite);
///     _Mem[memaddrdesc, size, accdesc] = value;
///     return;// AArch64.MemTag[] - non-assignment (read) form
/// // =============================================
...
///     // Memory array access
///     if AArch64.AllocationTagAccessIsEnabled() && memaddrdesc.memattrs.tagged then
///         _MemTag[memaddrdesc] = value;// AArch64.PhysicalTag()
/// // =====================
/// // Generate a Physical Tag from a Logical Tag in an address
/// 
/// bits(4) AArch64.PhysicalTag(bits(64) vaddr)
///     return vaddr<59:56>;// AArch64.TranslateAddressForAtomicAccess()
/// // =========================================
...
/// 
///     return memaddrdesc;// CheckSPAlignment()
/// // ==================
...
///         AArch64.SPAlignmentFault();
/// 
///     return;// If the implementation supports changing the block size without a break-before-make
/// // approach, then for implementations that have level 1 or 2 support, the nT bit in
/// // the block descriptor is valid.
/// boolean IsBlockDescriptorNTBitValid();// Returns True if the current instruction uses tag-checked memory access,
/// // False otherwise.
/// boolean IsTagCheckedInstruction();// Mem[] - non-assignment (read) form
/// // ==================================
/// // Perform a read of 'size' bytes. The access byte order is reversed for a big-endian access.
...
///     return oldvalue;// MemAtomicCompareAndSwap()
/// // =========================
...
///             newvalue = BigEndianReverse(newvalue);
///         _Mem[memaddrdesc, size DIV 8, staccdesc] = newvalue;
///     return oldvalue;// NVMem[] - non-assignment form
/// // =============================
...
///     return;// Flag the current instruction as using/not using memory tag checking.
/// SetTagCheckedInstruction(boolean checked);// This _MemTag[] accessor is the hardware operation which perform a single-copy atomic,
...
/// // etc and other parameters required to access the physical memory or for setting syndrome
/// // register in the event of an external abort.
/// _MemTag[AddressDescriptor desc, AccessDescriptor accdesc] = bits(4) value;// AddPAC()
/// // ========
...
///     else return AddPAC(X, Y, APDAKey_EL1, TRUE);// AddPACDB()
/// // ==========
/// // Returns a 64-bit value containing X, but replacing the pointer authentication code
/// // field bits with a pointer authentication code, where the pointer authentication
/// // code is derived using a cryptographic algorithm as a combination of X, Y and the
...
///     elsif TrapEL2 then TrapPACUse(EL2);
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else return AddPAC(X, Y, APDBKey_EL1, TRUE);// AddPACGA()
/// // ==========
...
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else return ComputePAC(X, Y, APGAKey_EL1<127:64>, APGAKey_EL1<63:0>)<63:32>:Zeros(32);// AddPACIA()
/// // ==========
/// // Returns a 64-bit value containing X, but replacing the pointer authentication code
/// // field bits with a pointer authentication code, where the pointer authentication
/// // code is derived using a cryptographic algorithm as a combination of X, Y, and the
...
///     elsif TrapEL2 then TrapPACUse(EL2);
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else return AddPAC(X, Y, APIAKey_EL1, FALSE);// AddPACIB()
/// // ==========
/// // Returns a 64-bit value containing X, but replacing the pointer authentication code
/// // field bits with a pointer authentication code, where the pointer authentication
/// // code is derived using a cryptographic algorithm as a combination of X, Y and the
...
///     elsif TrapEL2 then TrapPACUse(EL2);
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else return AddPAC(X, Y, APIBKey_EL1, FALSE);// AArch64.PACFailException()
/// // ==========================
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(EL1, exception, preferred_exception_return, vect_offset);// Auth()
/// // ======
...
///     elsif TrapEL2 then TrapPACUse(EL2);
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else  return Auth(X, Y, APDAKey_EL1, TRUE, '0', is_combined);// AuthDB()
/// // ========
/// // Returns a 64-bit value containing X, but replacing the pointer authentication code
...
///     elsif TrapEL2 then TrapPACUse(EL2);
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else  return Auth(X, Y, APDBKey_EL1, TRUE, '1', is_combined);// AuthIA()
/// // ========
/// // Returns a 64-bit value containing X, but replacing the pointer authentication code
/// // field bits with the extension of the address bits. The instruction checks a pointer
/// // authentication code in the pointer authentication code field bits of X, using the same
...
///     elsif TrapEL2 then TrapPACUse(EL2);
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else  return Auth(X, Y, APIAKey_EL1, FALSE, '0', is_combined);// AuthIB()
/// // ========
/// // Returns a 64-bit value containing X, but replacing the pointer authentication code
/// // field bits with the extension of the address bits. The instruction checks a pointer
/// // authentication code in the pointer authentication code field bits of X, using the same
...
///     elsif TrapEL2 then TrapPACUse(EL2);
///     elsif TrapEL3 then TrapPACUse(EL3);
///     else  return Auth(X, Y, APIBKey_EL1, FALSE, '1', is_combined);// CalculateBottomPACBit()
/// // =======================
/// 
...
///     return (64-tsz_field);// CalculateTBI()
/// // ==============
/// 
...
/// 
///     return tbi;array bits(64) RC[0..4];
/// 
...
/// 
///     return workingval;// PACCellInvShuffle()
/// // ===================
/// 
...
///     return outcell;// TweakCellInvRot()
/// // =================
/// 
...
///     outcell<1> = incell<2>;
///     outcell<0> = incell<1>;
///     return outcell;// TweakInvShuffle()
/// // =================
/// 
...
///     return outdata;// HaveEnhancedPAC()
/// // =================
/// // Returns TRUE if support for EnhancedPAC is implemented, FALSE otherwise.
/// 
/// boolean HaveEnhancedPAC()
///     return ( HavePACExt()
///         && boolean IMPLEMENTATION_DEFINED "Has enhanced PAC functionality" );// HaveEnhancedPAC2()
/// // ==================
/// // Returns TRUE if support for EnhancedPAC2 is implemented, FALSE otherwise.
/// 
/// boolean HaveEnhancedPAC2()
///     return HasArchVersion(ARMv8p6) || (HasArchVersion(ARMv8p3) && boolean IMPLEMENTATION_DEFINED "Has enhanced PAC 2 functionality");// HaveFPAC()
/// // ==========
/// // Returns TRUE if support for FPAC is implemented, FALSE otherwise.
/// 
/// boolean HaveFPAC()
///     return HaveEnhancedPAC2() && boolean IMPLEMENTATION_DEFINED "Has FPAC functionality";// HaveFPACCombined()
/// // ==================
/// // Returns TRUE if support for FPACCombined is implemented, FALSE otherwise.
/// 
/// boolean HaveFPACCombined()
///     return HaveFPAC() && boolean IMPLEMENTATION_DEFINED "Has FPAC Combined functionality";// HavePACExt()
/// // ============
/// // Returns TRUE if support for the PAC extension is implemented, FALSE otherwise.
/// 
/// boolean HavePACExt()
///     return HasArchVersion(ARMv8p3);// PtrHasUpperAndLowerAddRanges()
/// // ==============================
/// // Returns TRUE if the pointer has upper and lower address ranges, FALSE otherwise.
/// 
/// boolean PtrHasUpperAndLowerAddRanges()
///     return PSTATE.EL == EL1 || PSTATE.EL == EL0 || (PSTATE.EL == EL2 && HCR_EL2.E2H == '1');// Strip()
/// // =======
...
/// 
///     return original_ptr;// TrapPACUse()
/// // ============
...
///     AArch64.TakeException(target_el, exception, preferred_exception_return, vect_offset);// AArch64.ESBOperation()
/// // ======================
...
/// 
///     return;// Return the SError syndrome
/// bits(25) AArch64.PhysicalSErrorSyndrome(boolean implicit_esb);// AArch64.ReportDeferredSError()
/// // ==============================
...
///     return target;// AArch64.vESBOperation()
/// // =======================
...
/// 
///     return;// AArch64.MaybeZeroRegisterUppers()
/// // =================================
...
///             _R[n]<63:32> = Zeros();
/// 
///     return;// AArch64.ResetGeneralRegisters()
/// // ===============================
/// 
/// AArch64.ResetGeneralRegisters()
/// 
...
///         X[i] = bits(64) UNKNOWN;
/// 
///     return;// AArch64.ResetSIMDFPRegisters()
/// // ==============================
/// 
/// AArch64.ResetSIMDFPRegisters()
/// 
...
/// 
///     return;// AArch64.ResetSpecialRegisters()
/// // ===============================
/// 
/// AArch64.ResetSpecialRegisters()
/// 
...
///     DSPSR_EL0 = bits(32) UNKNOWN;
/// 
///     return;AArch64.ResetSystemRegisters(boolean cold_reset);// PC - non-assignment form
/// // ========================
/// // Read program counter.
/// 
/// bits(64) PC[]
///     return _PC;// SP[] - assignment form
/// // ======================
...
///             when EL3  return SP_EL3<width-1:0>;// V[] - assignment form
/// // =====================
...
///     assert n >= 0 && n <= 31;
///     assert width IN {8,16,32,64,128};
///     return _Z[n]<width-1:0>;// Vpart[] - non-assignment form
/// // =============================
...
///         assert width == 64;
///         bits(64) vreg = V[n];
///         V[n] = value<63:0> : vreg;// X[] - assignment form
/// // =====================
...
///     else
///         return Zeros(width);// AArch32.IsFPEnabled()
/// // =====================
...
/// 
///     return TRUE;// AArch64.IsFPEnabled()
/// // =====================
/// // Returns TRUE if access to the SIMD&FP instructions or System registers are
...
///     return FloorPow2(x - 1) * 2;// CheckSVEEnabled()
/// // =================
...
///         if CPTR_EL3.TFP == '1' then AArch64.AdvSIMDFPAccessTrap(EL3);// DecodePredCount()
/// // =================
/// 
...
///         otherwise    numElem = 0;
///     return numElem;// ElemFFR[] - non-assignment form
/// // ===============================
/// 
...
///     return;// ElemP[] - non-assignment form
/// // =============================
/// 
...
///     return;// FFR[] - non-assignment form
/// // ===========================
/// 
/// bits(width) FFR[]
///     assert width == PL;
...
///     else
///         _FFR<width-1:0> = value;// FPCompareNE()
/// // =============
/// 
...
///     if type1==FPType_SNaN || type2==FPType_SNaN then
///         FPProcessException(FPExc_InvalidOp, fpcr);
///     return (type1==FPType_SNaN || type1==FPType_QNaN || type2==FPType_SNaN || type2==FPType_QNaN);// FPConvertSVE()
/// // ==============
/// 
...
///     fpcr.AHP = '0';
///     return FPConvert(op, fpcr, FPRoundingMode(fpcr));// FPExpA()
/// // ========
/// 
...
/// 
///     return result;// FPExpCoefficient()
/// // ==================
/// 
...
/// 
///     return result<N-1:0>;// FPMinNormal()
/// // =============
/// 
...
///     exp = '0':Ones(E-1);
///     frac = Zeros(F);
///     return sign : exp : frac;// FPPointFive()
/// // =============
/// 
...
///     exp = '0':Ones(E-2):'0';
///     frac = Zeros(F);
///     return sign : exp : frac;// FPProcess()
/// // ===========
/// 
...
/// 
///     return result;// FPTrigMAddCoefficient()
/// // =======================
/// 
...
/// 
///     return result<N-1:0>;// FPTrigSMul()
/// // ============
/// 
...
/// 
/// boolean HaveSVE()
///     return HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Have SVE ISA";// HaveSVEFP32MatMulExt()
/// // ======================
...
///     return HaveSVE() && boolean IMPLEMENTATION_DEFINED "Have SVE FP32 Matrix Multiply extension";// HaveSVEFP64MatMulExt()
/// // ======================
...
///     return HaveSVE() && boolean IMPLEMENTATION_DEFINED "Have SVE FP64 Matrix Multiply extension";// ImplementedSVEVectorLength()
/// // ============================
/// // Reduce SVE vector length to a supported value (e.g. power of two)
/// 
/// integer ImplementedSVEVectorLength(integer nbits)
///     return integer IMPLEMENTATION_DEFINED;// IsEven()
/// // ========
/// 
/// boolean IsEven(integer val)
///     return val MOD 2 == 0;// IsFPEnabled()
/// // =============
...
///     else
///         return AArch64.IsFPEnabled(el);// IsSVEEnabled()
/// // ==============
...
///     return -1;constant integer MAX_PL = 256;constant integer MAX_VL = 2048;// MaybeZeroSVEUppers()
/// // ====================
/// 
...
///         if ConstrainUnpredictableBool(Unpredictable_SVEZEROUPPER) then
///             _FFR = ZeroExtend(_FFR<pl-1:0>);// MemNF[] - non-assignment form
/// // =============================
/// 
...
///         value = BigEndianReverse(value);
/// 
///     return (value, FALSE);// MemSingleNF[] - non-assignment form
/// // ===================================
/// 
...
///     return '1';// P[] - non-assignment form
/// // =========================
/// 
...
///     else
///         _P[n]<width-1:0> = value;// PL - non-assignment form
/// // ========================
/// 
/// integer PL
///     return VL DIV 8;// PredTest()
/// // ==========
/// 
...
///     bit v = '0';
///     return n:z:c:v;// ReducePredicated()
/// // ==================
/// 
...
/// 
///     return Reduce(op, operand, esize);// Reverse()
/// // =========
...
///         AArch64.TakeException(EL2, exception, preferred_exception_return, vect_offset);
///     else
///         AArch64.TakeException(target_el, exception, preferred_exception_return, vect_offset);enumeration SVECmp { Cmp_EQ, Cmp_NE, Cmp_GE, Cmp_GT, Cmp_LT, Cmp_LE, Cmp_UN };// SVEMoveMaskPreferred()
/// // ======================
...
///             return FALSE;
/// 
///     return TRUE;array bits(MAX_VL) _Z[0..31];
/// array bits(MAX_PL) _P[0..15];
/// bits(MAX_PL) _FFR;// VL - non-assignment form
/// // ========================
/// 
/// integer VL
///     integer vl;
...
/// 
///     return vl;// Z[] - non-assignment form
/// // =========================
/// 
...
///         _Z[n] = ZeroExtend(value);
///     else
///         _Z[n]<width-1:0> = value;// CNTKCTL[] - non-assignment form
/// // ===============================
/// 
/// CNTKCTLType CNTKCTL[]
///     bits(32) r;
...
///         return r;
///     r = CNTKCTL_EL1;
///     return r;type CNTKCTLType;// CPACR[] - non-assignment form
/// // =============================
/// 
/// CPACRType CPACR[]
///     bits(32) r;
...
///         return r;
///     r = CPACR_EL1;
///     return r;type CPACRType;// ELR[] - non-assignment form
/// // ===========================
/// 
...
///     assert PSTATE.EL != EL0;
///     ELR[PSTATE.EL] = value;
///     return;// ESR[] - non-assignment form
/// // ===========================
/// 
...
/// 
/// ESR[] = ESRType value
///     ESR[S1TranslationRegime()] = value;type ESRType;// FAR[] - non-assignment form
/// // ===========================
/// 
...
///     return;// MAIR[] - non-assignment form
/// // ============================
/// 
...
/// 
/// MAIRType MAIR[]
///     return MAIR[S1TranslationRegime()];type MAIRType;// SCTLR[] - non-assignment form
/// // =============================
/// 
...
/// 
/// SCTLRType SCTLR[]
///     return SCTLR[S1TranslationRegime()];type SCTLRType;// VBAR[] - non-assignment form
/// // ============================
/// 
...
/// 
/// bits(64) VBAR[]
///     return VBAR[S1TranslationRegime()];// AArch64.AllocationTagAccessIsEnabled()
/// // ======================================
...
///         return FALSE;
///     else
///         return TRUE;// AArch64.CheckSystemAccess()
/// // ===========================
...
/// 
///     return;// AArch64.ChooseNonExcludedTag()
/// // ==============================
...
///             tag = tag + '0001';
/// 
///     return tag;// AArch64.ExecutingATS1xPInstr()
/// // ==============================
...
///         return op1 == '000' && CRn == '0111' && CRm == '1001' && op2 IN {'000','001'};
///     else
///         return FALSE;// AArch64.ExecutingBROrBLROrRetInstr()
/// // ====================================
...
///         return opc != '0101';
///     else
///         return FALSE;// AArch64.ExecutingBTIInstr()
/// // ===========================
...
///     else
///         return FALSE;// AArch64.ExecutingERETInstr()
/// // ============================
/// // Returns TRUE if current instruction is ERET.
/// 
/// boolean AArch64.ExecutingERETInstr()
///     instr = ThisInstr();
///     return instr<31:12> == '11010110100111110000';// AArch64.GetMinELSecurityState()
/// // ===============================
...
///             min_EL = EL1;
///             need_secure = TRUE;
///     return (min_EL, need_secure);// AArch64.NextRandomTagBit()
/// // ==========================
...
///     return tag;// Execute a system instruction with write (source operand).
/// AArch64.SysInstr(integer op0, integer op1, integer crn, integer crm, integer op2, bits(64) val);// Execute a system instruction with read (result operand).
/// // Returns the result of the instruction.
/// bits(64) AArch64.SysInstrWithResult(integer op0, integer op1, integer crn, integer crm, integer op2);// Read from a system register and return the contents of the register.
/// bits(64) AArch64.SysRegRead(integer op0, integer op1, integer crn, integer crm, integer op2);// Write to a system register.
/// AArch64.SysRegWrite(integer op0, integer op1, integer crn, integer crm, integer op2, bits(64) val);boolean BTypeCompatible;// BTypeCompatible_BTI
/// // ===================
...
///         when '11'
///             return TRUE;// BTypeCompatible_PACIXSP()
/// // =========================
...
///     else
///         return FALSE;bits(2) BTypeNext;boolean InGuardedPage;// SetBTypeCompatible()
/// // ====================
/// // Sets the value of BTypeCompatible global variable used by BTI
/// 
/// SetBTypeCompatible(boolean x)
///     BTypeCompatible = x;// SetBTypeNext()
/// // ==============
/// // Set the value of BTypeNext global variable used by BTI
/// 
/// SetBTypeNext(bits(2) x)
///     BTypeNext = x;// The _ChooseRandomNonExcludedTag function is used when GCR_EL1.RRND == '1' to generate random
/// // Allocation Tags.
/// //
...
/// bits(4) _ChooseRandomNonExcludedTag(bits(16) exclude);// AArch64.ExceptionReturn()
/// // =========================
/// 
...
///     else
///         BranchToAddr(new_pc, BranchType_ERET);enumeration CountOp     {CountOp_CLZ, CountOp_CLS, CountOp_CNT};// DecodeRegExtend()
/// // =================
...
///         when '111' return ExtendType_SXTX;// ExtendReg()
/// // ===========
...
/// 
///     len = Min(len, N - shift);
///     return Extend(val<len-1:0> : Zeros(shift), N, unsigned);enumeration ExtendType  {ExtendType_SXTB, ExtendType_SXTH, ExtendType_SXTW, ExtendType_SXTX,
///                          ExtendType_UXTB, ExtendType_UXTH, ExtendType_UXTW, ExtendType_UXTX};enumeration FPMaxMinOp  {FPMaxMinOp_MAX, FPMaxMinOp_MIN,
///                          FPMaxMinOp_MAXNUM, FPMaxMinOp_MINNUM};enumeration FPUnaryOp   {FPUnaryOp_ABS, FPUnaryOp_MOV,
///                          FPUnaryOp_NEG, FPUnaryOp_SQRT};enumeration FPConvOp    {FPConvOp_CVT_FtoI, FPConvOp_CVT_ItoF,
...
/// 
///     return (wmask<M-1:0>, tmask<M-1:0>);enumeration MoveWideOp  {MoveWideOp_N, MoveWideOp_Z, MoveWideOp_K};// MoveWidePreferred()
/// // ===================
/// //
...
///         when '11'  return ShiftType_ROR;// ShiftReg()
/// // ==========
...
///     return result;enumeration ShiftType   {ShiftType_LSL, ShiftType_LSR, ShiftType_ASR, ShiftType_ROR};enumeration LogicalOp   {LogicalOp_AND, LogicalOp_EOR, LogicalOp_ORR};enumeration MemAtomicOp {MemAtomicOp_ADD,
///                          MemAtomicOp_BIC,
///                          MemAtomicOp_EOR,
///                          MemAtomicOp_ORR,
///                          MemAtomicOp_SMAX,
...
///                          MemAtomicOp_UMAX,
///                          MemAtomicOp_UMIN,
///                          MemAtomicOp_SWP};enumeration MemOp {MemOp_LOAD, MemOp_STORE, MemOp_PREFETCH};// Prefetch()
/// // ==========
/// 
...
///     return;enumeration MemBarrierOp   {  MemBarrierOp_DSB         // Data Synchronization Barrier
...
///     return Sys_SYS;enumeration SystemOp {Sys_AT, Sys_DC, Sys_IC, Sys_TLBI, Sys_SYS};enumeration VBitOp      {VBitOp_VBIF, VBitOp_VBIT, VBitOp_VBSL, VBitOp_VEOR};enumeration CompareOp   {CompareOp_GT, CompareOp_GE, CompareOp_EQ,
///                          CompareOp_LE, CompareOp_LT};enumeration ImmediateOp {ImmediateOp_MOVI, ImmediateOp_MVNI,
///                          ImmediateOp_ORR, ImmediateOp_BIC};// Reduce()
/// // ========
/// 
...
///             result = lo + hi;
/// 
///     return result;enumeration ReduceOp {ReduceOp_FMINNUM, ReduceOp_FMAXNUM,
///                       ReduceOp_FMIN, ReduceOp_FMAX,
///                       ReduceOp_FADD, ReduceOp_ADD};// AArch64.CombineS1S2Desc()
/// // =========================
/// // Combines the address descriptors from stage 1 and stage 2
/// 
...
///     result.memattrs = MemAttrDefaults(result.memattrs);
/// 
///     return result;// AArch64.InstructionDevice()
/// // ===========================
/// // Instruction fetches from memory marked as Device but not execute-never might generate a
/// // Permission Fault but are otherwise treated as if from Normal Non-cacheable memory.
/// 
...
///         addrdesc.memattrs = MemAttrDefaults(addrdesc.memattrs);
/// 
///     return addrdesc;// AArch64.S1AttrDecode()
/// // ======================
/// // Converts the Stage 1 attribute fields, using the MAIR, to orthogonal
/// // attributes and hints.
/// 
...
///         Unreachable();                          // Reserved, handled above
/// 
///     return MemAttrDefaults(memattrs);// AArch64.TranslateAddressS1Off()
/// // ===============================
/// // Called for stage 1 translations when translation is disabled to supply a default translation.
/// // Note that there are additional constraints on instruction prefetching that are not described in
/// // this pseudocode.
...
///     return result;// AArch64.AccessIsPrivileged()
/// // ============================
/// 
...
///         ispriv = (acctype != AccType_UNPRIV);
/// 
///     return ispriv;// AArch64.AccessUsesEL()
/// // ======================
/// // Returns the Exception Level of the regime that will manage the translation for a given access type.
/// 
...
///         return EL2;
///     else
///         return PSTATE.EL;// AArch64.CheckPermission()
/// // =========================
...
///                                        !failedread, secondstage, s2fs1walk);
///     else
///         return AArch64.NoFault();// AArch64.CheckS2Permission()
/// // ===========================
...
///                                        !failedread, secondstage, s2fs1walk);
///     else
///         return AArch64.NoFault();// AArch64.CheckBreakpoint()
/// // =========================
...
///     else
///         return AArch64.NoFault();// AArch64.CheckDebug()
/// // ====================
/// // Called on each access to check for a debug exception or entry to Debug state.
/// 
...
/// 
///     return fault;// AArch64.CheckWatchpoint()
/// // =========================
/// // Called before accessing the memory location of "size" bytes at "address",
/// // when either debug exceptions are enabled for the access, or halting debug
/// // is enabled and halting is allowed.
...
///         return AArch64.DebugFault(acctype, iswrite);
///     else
///         return AArch64.NoFault();// AArch64.AccessFlagFault()
/// // =========================
/// 
...
///                                      extflag, errortype, secondstage, s2fs1walk);// AArch64.AddressSizeFault()
/// // ==========================
/// 
...
///                                      extflag, errortype, secondstage, s2fs1walk);// AArch64.AlignmentFault()
/// // ========================
/// 
...
///                                      extflag, errortype, secondstage, s2fs1walk);// AArch64.AsynchExternalAbort()
/// // =============================
/// // Wrapper function for asynchronous external aborts
/// 
...
///                                       errortype, secondstage, s2fs1walk);// AArch64.DebugFault()
/// // ====================
/// 
...
///                                      extflag, errortype, secondstage, s2fs1walk);// AArch64.NoFault()
/// // =================
/// 
...
///                                      extflag, errortype, secondstage, s2fs1walk);// AArch64.PermissionFault()
/// // =========================
/// 
...
///                                      extflag, errortype, secondstage, s2fs1walk);// AArch64.TranslationFault()
/// // ==========================
/// 
...
///                                      extflag, errortype, secondstage, s2fs1walk);// AArch64.CheckAndUpdateDescriptor()
/// // ==================================
...
/// 
///     return fault;// AArch64.FirstStageTranslate()
/// // =============================
/// // Perform a stage 1 translation walk. The function used by Address Translation operations is
/// // similar except it uses the translation regime specified for the instruction.
/// 
...
/// 
///     return S1.addrdesc;// AArch64.FullTranslate()
/// // =======================
/// // Perform both stage 1 and stage 2 translation walks for the current translation regime. The
/// // function used by Address Translation operations is similar except it uses the translation
/// // regime specified for the instruction.
...
///         result = S1;
/// 
///     return result;// AArch64.SecondStageTranslate()
/// // ==============================
/// // Perform a stage 2 translation walk. The function used by Address Translation operations is
/// // similar except it uses the translation regime specified for the instruction.
/// 
...
///         result = S1;
/// 
///     return result;// AArch64.SecondStageWalk()
/// // =========================
/// // Perform a stage 2 translation on a stage 1 translation page table walk access.
/// 
...
///                                         size, hwupdatewalk);// AArch64.TranslateAddress()
/// // ==========================
/// // Main entry point for translating an address
/// 
...
///     result.vaddress = ZeroExtend(vaddress);
/// 
///     return result;// AArch64.TranslationTableWalk()
/// // ==============================
...
///     if HaveCommonNotPrivateTransExt() then result.CnP = baseregister<0>;
/// 
///     return result;// ClearStickyErrors()
/// // ===================
/// 
/// ClearStickyErrors()
...
/// bits(2) DebugTarget()
///     secure = IsSecure();
///     return DebugTargetFrom(secure);// DebugTargetFrom()
/// // =================
/// 
...
///         target = EL1;
/// 
///     return target;// DoubleLockStatus()
/// // ==================
...
///     else
///         return OSDLR_EL1.DLK == '1' && DBGPRCR_EL1.CORENPDRQ == '0' && !Halted();// AllowExternalDebugAccess()
/// // ==========================
...
///             return !IsSecure();
///     else
///         return FALSE;// AllowExternalPMUAccess()
/// // ========================
...
///              (ELUsingAArch32(EL1) && PSTATE.EL == EL0 && SDER.SUNIDEN == '1')));// ExternalNoninvasiveDebugEnabled()
/// // =================================
...
///     return !HaveNoninvasiveDebugAuth() || ExternalInvasiveDebugEnabled() || NIDEN == HIGH;// ExternalSecureInvasiveDebugEnabled()
/// // ====================================
/// // The definition of this function is IMPLEMENTATION DEFINED.
...
///     if !HaveEL(EL3) && !IsSecure() then return FALSE;
///     return ExternalInvasiveDebugEnabled() && SPIDEN == HIGH;// ExternalSecureNoninvasiveDebugEnabled()
/// // =======================================
...
///     else
///         return ExternalSecureInvasiveDebugEnabled();// Returns TRUE when an access is Secure
/// boolean IsAccessSecure();// Returns TRUE if the Core power domain is powered on, FALSE otherwise.
/// boolean IsCorePowered();// CheckValidStateMatch()
/// // ======================
...
///         // Otherwise the value returned by ConstrainUnpredictableBits must be a not-reserved value
/// 
///     return (Constraint_NONE, SSC, HMC, PxC);// Set a Cross Trigger multi-cycle input event trigger to the specified level.
/// CTI_SetEventLevel(CrossTriggerIn id, signal level);// Signal a discrete event on a Cross Trigger input event trigger.
/// CTI_SignalEvent(CrossTriggerIn id);enumeration CrossTriggerOut {CrossTriggerOut_DebugRequest, CrossTriggerOut_RestartRequest,
...
///                              CrossTriggerIn_TraceExtOut2,  CrossTriggerIn_TraceExtOut3};// CheckForDCCInterrupts()
/// // =======================
/// 
...
/// 
///     return;// DBGDTRRX_EL0[] (external write)
/// // ===============================
...
///     return DTRRX;// DBGDTRTX_EL0[] (external read)
/// // ==============================
...
///         result<31:0> = DTRRX;
///     EDSCR.RXfull = '0';
///     return result;bits(32) DTRRX;
/// bits(32) DTRTX;// EDITR[] (external write)
/// // ========================
...
///     UpdateEDSCRFields();                                // Update EDSCR PE state flags
/// 
///     return;constant bits(6) DebugHalt_Breakpoint      = '000111';
...
/// constant bits(6) DebugHalt_Step_NoSyndrome = '111011';DisableITRAndResumeInstructionPrefetch();// Execute an A64 instruction in Debug state.
/// ExecuteA64(bits(32) instr);// Execute a T32 instruction in Debug state.
/// ExecuteT32(bits(16) hw1, bits(16) hw2);// ExitDebugState()
/// // ================
/// 
/// ExitDebugState()
///     assert Halted();
...
///     UpdateEDSCRFields();                        // Update EDSCR PE state flags.
/// 
///     return;// HaltOnBreakpointOrWatchpoint()
/// // ==============================
...
///     return HaltingAllowed() && EDSCR.HDE == '1' && OSLSR_EL1.OSLK == '0';// Halted()
/// // ========
/// 
/// boolean Halted()
///     return !(EDSCR.STATUS IN {'000001', '000010'});                     // Halted// HaltingAllowed()
/// // ================
...
///     else
///         return ExternalInvasiveDebugEnabled();// Restarting()
/// // ============
/// 
/// boolean Restarting()
///     return EDSCR.STATUS == '000001';                                    // RestartingStopInstructionPrefetchAndEnableITR();// UpdateEDSCRFields()
/// // ===================
...
///         if halt then Halt(DebugHalt_ExceptionCatch);// CheckHaltingStep()
/// // ==================
...
///         else
///             Halt(DebugHalt_Step_Normal);// CheckOSUnlockCatch()
/// // ====================
...
///     then
///         if !Halted() then EDESR.OSUC = '1';// CheckPendingOSUnlockCatch()
/// // ===========================
...
///         if HaltingAllowed() then Halt(DebugHalt_ResetCatch);// CheckSoftwareAccessToDebugRegisters()
/// // =====================================
...
///         Halt(DebugHalt_SoftwareAccess);// ExternalDebugRequest()
/// // ======================
/// 
/// ExternalDebugRequest()
///     if HaltingAllowed() then
///         Halt(DebugHalt_EDBGRQ);
///     // Otherwise the CTI continues to assert the debug request until it is taken.// Returns TRUE if the previously executed instruction was executed in the inactive state, that is,
/// // if it was not itself stepped.
/// boolean HaltingStep_DidNotStep();// Returns TRUE if the previously executed instruction was a Load-Exclusive class instruction
/// // executed in the active-not-pending state.
/// boolean HaltingStep_SteppedEX();// RunHaltingStep()
/// // ================
/// 
...
/// 
///     return;// ExternalDebugInterruptsDisabled()
/// // =================================
...
///     return int_dis;enumeration InterruptID {InterruptID_PMUIRQ, InterruptID_COMMIRQ, InterruptID_CTIIRQ,
///                          InterruptID_COMMRX, InterruptID_COMMTX};// Set a level-sensitive interrupt to the specified level.
/// SetInterruptRequestLevel(InterruptID id, signal level);// CreatePCSample()
/// // ================
/// 
/// CreatePCSample()
...
/// 
///     return sample;type PCSample is (
///     boolean valid,
///     bits(64) pc,
///     bits(2) el,
///     bit rw,
...
/// )
/// 
/// PCSample pc_sample;// PMPCSR[] (read)
/// // ===============
/// 
...
/// 
///     return sample;// CheckSoftwareStep()
/// // ===================
...
///             AArch64.SoftwareStepException();// DebugExceptionReturnSS()
/// // ========================
...
/// 
///     return;// Returns TRUE if the previously executed instruction was executed in the inactive state, that is,
/// // if it was not itself stepped.
...
/// boolean SoftwareStep_DidNotStep();// Returns a value that describes the previously executed instruction. The result is valid only if
...
/// boolean SoftwareStep_SteppedEX();// ConditionSyndrome()
/// // ===================
...
///         syndrome<3:0> = '1110';
/// 
///     return syndrome;enumeration Exception {Exception_Uncategorized,       // Uncategorized or unknown reason
...
///                        Exception_FIQ};                // FIQ interrupttype ExceptionRecord is (Exception exceptype,         // Exception class
...
///                          bits(52)  ipaddress)         // Physical fault address for second stage faults// ExceptionSyndrome()
/// // ===================
...
///         AArch32.TakeUndefInstrException();
///     else
///         AArch64.UndefinedFault();// UnallocatedEncoding()
/// // =====================
/// 
/// UnallocatedEncoding()
...
///         AArch32.TakeUndefInstrException();
///     else
///         AArch64.UndefinedFault();// EncodeLDFSC()
/// // =============
...
///     return IsAsyncAbort(fault.statuscode);// IsDebugException()
/// // ==================
/// 
/// boolean IsDebugException(FaultRecord fault)
///     assert fault.statuscode != Fault_None;
///     return fault.statuscode == Fault_Debug;// IsExternalAbort()
/// // =================
...
///     return IsExternalAbort(fault.statuscode);// IsExternalSyncAbort()
/// // =====================
...
///     return IsExternalSyncAbort(fault.statuscode);// IsFault()
/// // =========
/// // Return TRUE if a fault is associated with an address descriptor
/// 
/// boolean IsFault(AddressDescriptor addrdesc)
///     return addrdesc.fault.statuscode != Fault_None;// IsSErrorInterrupt()
/// // ===================
...
///     return IsSErrorInterrupt(fault.statuscode);// IsSecondStage()
/// // ===============
/// 
/// boolean IsSecondStage(FaultRecord fault)
///     assert fault.statuscode != Fault_None;
/// 
///     return fault.secondstage;bits(11) LSInstructionSyndrome();// ASR()
/// // =====
/// 
...
/// 
/// real Abs(real x)
///     return if x >= 0.0 then x else -x;// Align()
/// // =======
/// 
...
///     return Align(UInt(x), y)<N-1:0>;// BitCount()
/// // ==========
/// 
...
///         if x<i> == '1' then
///             result = result + 1;
///     return result;// CountLeadingSignBits()
/// // ======================
/// 
/// integer CountLeadingSignBits(bits(N) x)
///     return CountLeadingZeroBits(x<N-1:1> EOR x<N-2:0>);// CountLeadingZeroBits()
/// // ======================
/// 
/// integer CountLeadingZeroBits(bits(N) x)
///     return N - (HighestSetBit(x) + 1);// Elem[] - non-assignment form
/// // ============================
/// 
...
///     return Extend(x, N, unsigned);// HighestSetBit()
/// // ===============
/// 
...
///     return result;// IsOnes()
/// // ========
/// 
/// boolean IsOnes(bits(N) x)
///     return x == Ones(N);// IsZero()
/// // ========
/// 
/// boolean IsZero(bits(N) x)
///     return x == Zeros(N);// IsZeroBit()
/// // ===========
/// 
/// bit IsZeroBit(bits(N) x)
///     return if IsZero(x) then '1' else '0';// LSL()
/// // =====
/// 
...
///     result = extended_x<shift+N-1:shift>;
///     carry_out = extended_x<shift-1>;
///     return (result, carry_out);// LowestSetBit()
/// // ==============
/// 
...
///     return if a >= b then a else b;// Min()
/// // =====
/// 
...
///     return if a <= b then a else b;// Ones()
/// // ======
/// 
...
///     return (result, carry_out);// Replicate()
/// // ===========
/// 
...
/// 
/// bits(M*N) Replicate(bits(M) x, integer N);integer RoundDown(real x);// RoundTowardsZero()
/// // ==================
/// 
/// integer RoundTowardsZero(real x)
///     return if x == 0.0 then 0 else if x >= 0.0 then RoundDown(x) else RoundUp(x);integer RoundUp(real x);// SInt()
/// // ======
/// 
...
///     for i = 0 to N-1
///         result<N-i-1> = data<i>;
///     return result;// HaveCRCExt()
/// // ============
/// 
/// boolean HaveCRCExt()
///     return HasArchVersion(ARMv8p1) || boolean IMPLEMENTATION_DEFINED "Have CRC extension";// Poly32Mod2()
/// // ============
/// 
...
///     return data<31:0>;// AESInvMixColumns()
/// // ==================
...
///     );
///     return FFmul_02<UInt(b)*8+:8>;// FFmul03()
/// // =========
/// 
...
///     );
///     return FFmul_03<UInt(b)*8+:8>;// FFmul09()
/// // =========
/// 
...
///     );
///     return FFmul_09<UInt(b)*8+:8>;// FFmul0B()
/// // =========
/// 
...
///     );
///     return FFmul_0B<UInt(b)*8+:8>;// FFmul0D()
/// // =========
/// 
...
///     );
///     return FFmul_0D<UInt(b)*8+:8>;// FFmul0E()
/// // =========
/// 
...
///     );
///     return FFmul_0E<UInt(b)*8+:8>;// HaveAESExt()
/// // ============
/// // TRUE if AES cryptographic instructions support is implemented,
/// // FALSE otherwise.
/// 
/// boolean HaveAESExt()
///     return boolean IMPLEMENTATION_DEFINED "Has AES Crypto instructions";// HaveBit128PMULLExt()
/// // ====================
/// // TRUE if 128 bit form of PMULL instructions support is implemented,
/// // FALSE otherwise.
/// 
/// boolean HaveBit128PMULLExt()
///     return boolean IMPLEMENTATION_DEFINED "Has 128-bit form of PMULL instructions";// HaveSHA1Ext()
/// // =============
/// // TRUE if SHA1 cryptographic instructions support is implemented,
/// // FALSE otherwise.
/// 
/// boolean HaveSHA1Ext()
///     return boolean IMPLEMENTATION_DEFINED "Has SHA1 Crypto instructions";// HaveSHA256Ext()
/// // ===============
/// // TRUE if SHA256 cryptographic instructions support is implemented,
/// // FALSE otherwise.
/// 
/// boolean HaveSHA256Ext()
///     return boolean IMPLEMENTATION_DEFINED "Has SHA256 Crypto instructions";// HaveSHA3Ext()
/// // =============
...
///         return FALSE;
///     return boolean IMPLEMENTATION_DEFINED "Has SHA3 Crypto instructions";// HaveSHA512Ext()
/// // ===============
...
///     if !HasArchVersion(ARMv8p2) || !(HaveSHA1Ext() && HaveSHA256Ext()) then
///         return FALSE;
///     return boolean IMPLEMENTATION_DEFINED "Has SHA512 Crypto instructions";// HaveSM3Ext()
/// // ============
...
///         return FALSE;
///     return boolean IMPLEMENTATION_DEFINED "Has SM3 Crypto instructions";// HaveSM4Ext()
/// // ============
...
///     if !HasArchVersion(ARMv8p2) then
///         return FALSE;
///     return boolean IMPLEMENTATION_DEFINED "Has SM4 Crypto instructions";// ROL()
/// // =====
/// 
...
///     if (shift == 0) then
///         return x;
///     return ROR(x, N-shift);// SHA256hash()
/// // ============
/// 
...
///         <Y, X> = ROL(Y : X, 32);
///     return (if part1 then X else Y);// SHAchoose()
/// // ===========
/// 
/// bits(32) SHAchoose(bits(32) x, bits(32) y, bits(32) z)
///     return (((y EOR z) AND x) EOR z);// SHAhashSIGMA0()
/// // ===============
/// 
/// bits(32) SHAhashSIGMA0(bits(32) x)
///     return ROR(x, 2) EOR ROR(x, 13) EOR ROR(x, 22);// SHAhashSIGMA1()
/// // ===============
/// 
/// bits(32) SHAhashSIGMA1(bits(32) x)
///     return ROR(x, 6) EOR ROR(x, 11) EOR ROR(x, 25);// SHAmajority()
/// // =============
/// 
/// bits(32) SHAmajority(bits(32) x, bits(32) y, bits(32) z)
///     return ((x AND y) OR ((x OR y) AND z));// SHAparity()
/// // ===========
/// 
/// bits(32) SHAparity(bits(32) x, bits(32) y, bits(32) z)
///     return (x EOR y EOR z);// Sbox()
/// // ======
...
///     return sboxout;// Clear the global Exclusives monitors for all PEs EXCEPT processorid if they
...
/// ClearExclusiveByAddress(FullAddress paddress, integer processorid, integer size);// Clear the local Exclusives monitor for the specified processorid.
/// ClearExclusiveLocal(integer processorid);// ClearExclusiveMonitors()
/// // ========================
/// 
/// // Clear the local Exclusives monitor for the executing PE.
/// 
/// ClearExclusiveMonitors()
///     ClearExclusiveLocal(ProcessorID());// Returns '0' to indicate success if the last memory write by this PE was to
...
/// // physical address.
/// bit ExclusiveMonitorsStatus();// Return TRUE if the global Exclusives monitor for processorid includes all of
/// // the physical address region of size bytes starting at paddress.
/// boolean IsExclusiveGlobal(FullAddress paddress, integer processorid, integer size);// Return TRUE if the local Exclusives monitor for processorid includes all of
/// // the physical address region of size bytes starting at paddress.
/// boolean IsExclusiveLocal(FullAddress paddress, integer processorid, integer size);// Record the physical address region of size bytes starting at paddress in
/// // the global Exclusives monitor for processorid.
/// MarkExclusiveGlobal(FullAddress paddress, integer processorid, integer size);// Record the physical address region of size bytes starting at paddress in
/// // the local Exclusives monitor for processorid.
/// MarkExclusiveLocal(FullAddress paddress, integer processorid, integer size);// Return the ID of the currently executing PE.
/// integer ProcessorID();// AArch32.HaveHPDExt()
/// // ====================
/// 
/// boolean AArch32.HaveHPDExt()
///     return HasArchVersion(ARMv8p2);// AArch64.HaveHPDExt()
/// // ====================
/// 
/// boolean AArch64.HaveHPDExt()
///     return HasArchVersion(ARMv8p1);// Have52BitPAExt()
/// // ================
/// // Returns TRUE if Large Physical Address extension
/// // support is implemented and FALSE otherwise.
/// 
/// boolean Have52BitPAExt()
///     return HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has large 52-bit PA/IPA support";// Have52BitVAExt()
/// // ================
/// // Returns TRUE if Large Virtual Address extension
/// // support is implemented and FALSE otherwise.
/// 
/// boolean Have52BitVAExt()
///     return HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has large 52-bit VA support";// HaveAArch32BF16Ext()
/// // ====================
/// // Returns TRUE if AArch32 BFloat16 instruction support is implemented, and FALSE otherwise.
/// 
/// boolean HaveAArch32BF16Ext()
///     return HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has AArch32 BFloat16 extension";// HaveAArch32Int8MatMulExt()
/// // ==========================
...
///     return HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has AArch32 Int8 Mat Mul extension";// HaveAtomicExt()
/// // ===============
/// 
/// boolean HaveAtomicExt()
///     return HasArchVersion(ARMv8p1);// HaveBF16Ext()
/// // =============
/// // Returns TRUE if AArch64 BFloat16 instruction support is implemented, and FALSE otherwise.
/// 
/// boolean HaveBF16Ext()
///     return HasArchVersion(ARMv8p6) || (HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has AArch64 BFloat16 extension");// HaveBTIExt()
/// // ============
/// // Returns TRUE if support for Branch Target Indentification is implemented.
/// 
/// boolean HaveBTIExt()
///     return HasArchVersion(ARMv8p5);// HaveBlockBBM()
/// // ==============
/// // Returns TRUE if support for changing block size without requring break-before-make is implemented.
/// 
/// boolean HaveBlockBBM()
///     return HasArchVersion(ARMv8p4);// HaveCommonNotPrivateTransExt()
/// // ==============================
/// 
/// boolean HaveCommonNotPrivateTransExt()
///     return HasArchVersion(ARMv8p2);// HaveDGHExt()
/// // ============
/// // Returns TRUE if Data Gathering Hint instruction support is implemented, and FALSE otherwise.
/// 
/// boolean HaveDGHExt()
///     return boolean IMPLEMENTATION_DEFINED "Has AArch64 DGH extension";// HaveDITExt()
/// // ============
/// 
/// boolean HaveDITExt()
///     return HasArchVersion(ARMv8p4);// HaveDOTPExt()
/// // =============
/// // Returns TRUE if Dot Product feature support is implemented, and FALSE otherwise.
/// 
/// boolean HaveDOTPExt()
///     return HasArchVersion(ARMv8p4) || (HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has Dot Product extension");// HaveDoPD()
/// // ==========
/// // Returns TRUE if Debug Over Power Down extension
/// // support is implemented and FALSE otherwise.
/// 
/// boolean HaveDoPD()
///     return HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has DoPD extension";// HaveDoubleFaultExt()
/// // ====================
/// 
/// boolean HaveDoubleFaultExt()
///     return (HasArchVersion(ARMv8p4) && HaveEL(EL3) && !ELUsingAArch32(EL3) && HaveIESB());// HaveDoubleLock()
/// // ================
/// // Returns TRUE if support for the OS Double Lock is implemented.
/// 
/// boolean HaveDoubleLock()
///     return !HasArchVersion(ARMv8p4) || boolean IMPLEMENTATION_DEFINED "OS Double Lock is implemented";// HaveE0PDExt()
/// // =============
/// // Returns TRUE if support for constant fault times for unprivileged accesses
/// // to the memory map is implemented.
/// 
/// boolean HaveE0PDExt()
///     return HasArchVersion(ARMv8p5);// HaveEMPAMExt()
/// // ==============
...
///             HaveMPAMExt() &&
///             boolean IMPLEMENTATION_DEFINED "Has enhanced MPAM extension");// HaveExtendedCacheSets()
/// // =======================
/// 
/// boolean HaveExtendedCacheSets()
///     return HasArchVersion(ARMv8p3);// HaveExtendedECDebugEvents()
/// // ===========================
/// 
/// boolean HaveExtendedECDebugEvents()
///     return HasArchVersion(ARMv8p2);// HaveExtendedExecuteNeverExt()
/// // =============================
/// 
/// boolean HaveExtendedExecuteNeverExt()
///     return HasArchVersion(ARMv8p2);// HaveFCADDExt()
/// // ==============
/// 
/// boolean HaveFCADDExt()
///     return HasArchVersion(ARMv8p3);// HaveFGTExt()
/// // ============
/// // Returns TRUE if Fine Grained Trap is implemented, and FALSE otherwise.
/// 
/// boolean HaveFGTExt()
///     return HasArchVersion(ARMv8p6) && !ELUsingAArch32(EL2);// HaveFJCVTZSExt()
/// // ================
/// 
/// boolean HaveFJCVTZSExt()
///     return HasArchVersion(ARMv8p3);// HaveFP16MulNoRoundingToFP32Ext()
/// // ================================
...
///             boolean IMPLEMENTATION_DEFINED "Has accumulate FP16 product into FP32 extension");// HaveFlagFormatExt()
/// // ===================
/// // Returns TRUE if flag format conversion instructions implemented.
/// 
/// boolean HaveFlagFormatExt()
///     return HasArchVersion(ARMv8p5);// HaveFlagManipulateExt()
/// // =======================
/// // Returns TRUE if flag manipulate instructions are implemented.
/// 
/// boolean HaveFlagManipulateExt()
///     return HasArchVersion(ARMv8p4);// HaveFrintExt()
/// // ==============
/// // Returns TRUE if FRINT instructions are implemented.
/// 
/// boolean HaveFrintExt()
///     return HasArchVersion(ARMv8p5);// HaveHPMDExt()
/// // =============
/// 
/// boolean HaveHPMDExt()
///     return HasArchVersion(ARMv8p1);// HaveIDSExt()
/// // ============
/// // Returns TRUE if ID register handling feature is implemented.
/// 
/// boolean HaveIDSExt()
///     return HasArchVersion(ARMv8p4);// HaveIESB()
/// // ==========
/// 
/// boolean HaveIESB()
///     return (HaveRASExt() &&
///             boolean IMPLEMENTATION_DEFINED "Has Implicit Error Synchronization Barrier");// HaveInt8MatMulExt()
/// // ===================
/// // Returns TRUE if AArch64 8-bit integer matrix multiply instruction support
/// // implemented, and FALSE otherwise.
/// 
/// boolean HaveInt8MatMulExt()
///     return HasArchVersion(ARMv8p6) || (HasArchVersion(ARMv8p2) && boolean IMPLEMENTATION_DEFINED "Has AArch64 Int8 Mat Mul extension");// HaveMPAMExt()
/// // =============
/// // Returns TRUE if MPAM is implemented, and FALSE otherwise.
/// 
/// boolean HaveMPAMExt()
///     return (HasArchVersion(ARMv8p2) &&
///             boolean IMPLEMENTATION_DEFINED "Has MPAM extension");// HaveMTEExt()
/// // ============
...
///         return FALSE;
///     return boolean IMPLEMENTATION_DEFINED "Has MTE extension";// HaveNV2Ext()
/// // ============
/// // Returns TRUE if Enhanced Nested Virtualization is implemented.
/// 
/// boolean HaveNV2Ext()
///     return (HasArchVersion(ARMv8p4) && HaveNVExt()
///             && boolean IMPLEMENTATION_DEFINED "Has support for Enhanced Nested Virtualization");// HaveNVExt()
/// // ===========
/// // Returns TRUE if Nested Virtualization is implemented.
/// 
/// boolean HaveNVExt()
///     return HasArchVersion(ARMv8p3) && boolean IMPLEMENTATION_DEFINED "Has Nested Virtualization";// HaveNoSecurePMUDisableOverride()
/// // ================================
/// 
/// boolean HaveNoSecurePMUDisableOverride()
///     return HasArchVersion(ARMv8p2);// HaveNoninvasiveDebugAuth()
/// // ==========================
/// // Returns TRUE if the Non-invasive debug controls are implemented.
/// 
/// boolean HaveNoninvasiveDebugAuth()
///     return !HasArchVersion(ARMv8p4);// HavePANExt()
/// // ============
/// 
/// boolean HavePANExt()
///     return HasArchVersion(ARMv8p1);// HavePageBasedHardwareAttributes()
/// // =================================
/// 
/// boolean HavePageBasedHardwareAttributes()
///     return HasArchVersion(ARMv8p2);// HavePrivATExt()
/// // ===============
/// 
/// boolean HavePrivATExt()
///     return HasArchVersion(ARMv8p2);// HaveQRDMLAHExt()
/// // ================
/// 
...
///     return HasArchVersion(ARMv8p1);// HaveRASExt()
/// // ============
/// 
/// boolean HaveRASExt()
///     return (HasArchVersion(ARMv8p2) ||
///             boolean IMPLEMENTATION_DEFINED "Has RAS extension");// HaveRNG()
/// // =========
/// // Returns TRUE if Random Number Generator extension
/// // support is implemented and FALSE otherwise.
/// 
/// boolean HaveRNG()
///     return HasArchVersion(ARMv8p5) && boolean IMPLEMENTATION_DEFINED "Has RNG extension";// HaveSBExt()
/// // ===========
/// // Returns TRUE if support for SB is implemented, and FALSE otherwise.
/// 
/// boolean HaveSBExt()
///     return HasArchVersion(ARMv8p5) || boolean IMPLEMENTATION_DEFINED "Has SB extension";// HaveSSBSExt()
/// // =============
/// // Returns TRUE if support for SSBS is implemented, and FALSE otherwise.
/// 
/// boolean HaveSSBSExt()
///     return HasArchVersion(ARMv8p5) || boolean IMPLEMENTATION_DEFINED "Has SSBS extension";// HaveSecureEL2Ext()
/// // ==================
/// // Returns TRUE if Secure EL2 is implemented.
/// 
/// boolean HaveSecureEL2Ext()
///     return HasArchVersion(ARMv8p4);// HaveSecureExtDebugView()
/// // ========================
...
///     return HasArchVersion(ARMv8p4);// HaveSelfHostedTrace()
/// // =====================
/// 
/// boolean HaveSelfHostedTrace()
///     return HasArchVersion(ARMv8p4);// HaveSmallPageTblExt()
/// // =====================
/// // Returns TRUE if Small Page Table Support is implemented.
/// 
/// boolean HaveSmallPageTblExt()
///     return HasArchVersion(ARMv8p4) && boolean IMPLEMENTATION_DEFINED "Has Small Page Table extension";// HaveStage2MemAttrControl()
/// // ==========================
...
///     return HasArchVersion(ARMv8p4);// HaveStatisticalProfiling()
/// // ==========================
/// 
/// boolean HaveStatisticalProfiling()
///     return HasArchVersion(ARMv8p2);// HaveTraceExt()
/// // ==============
/// // Returns TRUE if Trace functionality as described by the Trace Architecture
/// // is implemented.
/// 
/// boolean HaveTraceExt()
///     return boolean IMPLEMENTATION_DEFINED "Has Trace Architecture functionality";// HaveTrapLoadStoreMultipleDeviceExt()
/// // ====================================
/// 
/// boolean HaveTrapLoadStoreMultipleDeviceExt()
///     return HasArchVersion(ARMv8p2);// HaveUA16Ext()
/// // =============
/// // Returns TRUE if extended unaligned memory access support is implemented, and FALSE otherwise.
/// 
/// boolean HaveUA16Ext()
///     return HasArchVersion(ARMv8p4);// HaveUAOExt()
/// // ============
/// 
/// boolean HaveUAOExt()
///     return HasArchVersion(ARMv8p2);// HaveVirtHostExt()
/// // =================
/// 
/// boolean HaveVirtHostExt()
///     return HasArchVersion(ARMv8p1);// If SCTLR_ELx.IESB is 1 when an exception is generated to ELx, any pending Unrecoverable
...
/// boolean InsertIESBBeforeException(bits(2) el);// BFAdd()
/// // =======
...
/// 
///     return (fptype, sign, value);// FPConvertBF()
/// // =============
...
///     return FPConvertBF(op, fpcr, FPRoundingMode(fpcr));// FPRoundCVBF()
/// // =============
...
///     return FPRoundBase(op, fpcr, rounding, isbfloat);// FixedToFP()
/// // ===========
/// 
...
///     return FPConvert(op, fpcr, FPRoundingMode(fpcr));// FPConvertNaN()
/// // ==============
...
/// 
///     return result;type FPCRType;// FPDecodeRM()
/// // ============
/// 
...
///         when '11' return FPRounding_NEGINF;  // M// FPDecodeRounding()
/// // ==================
/// 
...
///         when '11' return FPRounding_ZERO;    // Z// FPDefaultNaN()
/// // ==============
/// 
/// bits(N) FPDefaultNaN()
///     assert N IN {16,32,64};
...
///     return result;enumeration FPExc       {FPExc_InvalidOp, FPExc_DivideByZero, FPExc_Overflow,
///                          FPExc_Underflow, FPExc_Inexact, FPExc_InputDenorm};// FPInfinity()
/// // ============
/// 
...
///     bits(E) exp  = Ones(E);
///     bits(F) frac = Zeros(F);
///     return sign : exp : frac;// FPMatMulAdd()
/// // =============
/// //
...
///         op2 = FPInfinity('1');
/// 
///     return FPMax(op1, op2, fpcr);// FPMin()
/// // =======
/// 
...
///         op2 = FPInfinity('0');
/// 
///     return FPMin(op1, op2, fpcr);// FPMul()
/// // =======
/// 
...
///     assert N IN {16,32,64};
///     return NOT(op<N-1>) : op<N-2:0>;// FPOnePointFive()
/// // ================
/// 
...
///     exp  = '0':Ones(E-1);
///     frac = '1':Zeros(F-1);
///     return sign : exp : frac;// FPProcessException()
/// // ====================
/// //
...
///     else
///         done = FALSE;  result = Zeros();  // 'Don't care' result
///     return (done, result);// FPProcessNaNs3()
/// // ================
/// //
/// // The boolean part of the return value says whether a NaN has been found and
/// // processed. The bits(N) part is only relevant if it has and supplies the
...
///     else
///         done = FALSE;  result = Zeros();  // 'Don't care' result
///     return (done, result);// FPRecipEstimate()
/// // =================
/// 
...
/// 
///     return result;// Compute estimate of reciprocal of 9-bit fixed-point number
/// //
...
///     return FPRound(op, fpcr, FPRoundingMode(fpcr));// FPRoundCV()
/// // ===========
...
///     fpcr.FZ16 = '0';
///     boolean isbfloat = FALSE;
///     return FPRoundBase(op, fpcr, rounding, isbfloat);enumeration FPRounding  {FPRounding_TIEEVEN, FPRounding_POSINF,
///                          FPRounding_NEGINF,  FPRounding_ZERO,
///                          FPRounding_TIEAWAY, FPRounding_ODD};// FPRoundingMode()
/// // ================
/// 
/// // Return the current floating-point rounding mode.
/// 
/// FPRounding FPRoundingMode(FPCRType fpcr)
///     return FPDecodeRounding(fpcr.RMode);// FPRoundInt()
/// // ============
/// 
...
///     return result;// Compute estimate of reciprocal square root of 9-bit fixed-point number
/// //
...
///     exp  = '1':Zeros(E-1);
///     frac = '1':Zeros(F-1);
///     return sign : exp : frac;// FPToFixed()
/// // ===========
/// 
...
///     exp  = '1':Zeros(E-1);
///     frac = Zeros(F);
///     return sign : exp : frac;enumeration FPType      {FPType_Nonzero, FPType_Zero, FPType_Infinity,
///                          FPType_QNaN, FPType_SNaN};// FPUnpack()
/// // ==========
/// //
/// // Used by data processing and int/fixed <-> FP conversion instructions.
/// // For half-precision data it ignores AHP, and observes FZ16.
...
///     return (fp_type, sign, value);// FPUnpackBase()
/// // ==============
/// //
...
/// 
///     if sign == '1' then value = -value;
///     return (fptype, sign, value);// FPUnpackCV()
/// // ============
/// //
/// // Used for FP <-> FP conversion instructions.
/// // For half-precision data ignores FZ16 and observes AHP.
...
///     fpcr.FZ16 = '0';
///     (fp_type, sign, value) = FPUnpackBase(fpval, fpcr);
///     return (fp_type, sign, value);// FPZero()
/// // ========
/// 
...
///     exp  = Zeros(E);
///     frac = Zeros(F);
///     return sign : exp : frac;// VFPExpandImm()
/// // ==============
/// 
...
///     return sign : exp : frac;// AddWithCarry()
/// // ==============
...
///     return (result, n:z:c:v);// AArch64.BranchAddr()
/// // ====================
...
///     else
///         return ZeroExtend(vaddress<msbit:0>);enumeration AccType {AccType_NORMAL, AccType_VEC,        // Normal loads and stores
...
///                      AccType_AT};                        // Address translationtype AccessDescriptor is (
///     AccType acctype,
///     MPAMinfo mpam,
...
/// 
///     return (if tbi == '1' && (!HavePACExt() || tbid == '0' || !IsInstr ) then 55 else 63);type AddressDescriptor is (
...
/// constant bits(2) MemHint_RWA = '11';    // Read-Allocate, Write-Allocate// BigEndian()
/// // ===========
/// 
/// boolean BigEndian()
///     boolean bigend;
...
///     else
///         bigend = (SCTLR[].EE != '0');
///     return bigend;// BigEndianReverse()
/// // ==================
/// 
...
///     return BigEndianReverse(value<half-1:0>) : BigEndianReverse(value<width-1:half>);constant bits(2) MemAttr_NC = '00';     // Non-cacheable
/// constant bits(2) MemAttr_WT = '10';     // Write-through
/// constant bits(2) MemAttr_WB = '11';     // Write-back// CreateAccessDescriptor()
/// // ========================
/// 
...
///     return accdesc;// CreateAccessDescriptorPTW()
/// // ===========================
/// 
...
///     accdesc.level = level;
///     return accdesc;DataMemoryBarrier(MBReqDomain domain, MBReqTypes types);DataSynchronizationBarrier(MBReqDomain domain, MBReqTypes types);type DescriptorUpdate is (
///     boolean AF,                  // AF needs to be set
///     boolean AP,                  // AP[2] / S2AP[2] will be modified
///     AddressDescriptor descaddr   // Descriptor to be updated
/// )enumeration DeviceType {DeviceType_GRE, DeviceType_nGRE, DeviceType_nGnRE, DeviceType_nGnRnE};// EffectiveTBI()
/// // ==============
...
///             if HavePACExt() then tbid = TCR_EL3.TBID;
/// 
///     return (if tbi == '1' && (!HavePACExt() || tbid == '0' || !IsInstr) then '1' else '0');// EffectiveTCMA()
/// // ===============
...
///             tcma = TCR_EL3.TCMA;
/// 
///     return tcma;enumeration Fault {Fault_None,
///                    Fault_AccessFlag,
///                    Fault_Alignment,
///                    Fault_Background,
///                    Fault_Domain,
...
///                    Fault_Lockdown,
///                    Fault_Exclusive,
///                    Fault_ICacheMaint};type FaultRecord is (Fault    statuscode,  // Fault Status
...
/// Hint_Prefetch(bits(64) address, PrefetchHint hint, integer target, boolean stream);enumeration MBReqDomain    {MBReqDomain_Nonshareable, MBReqDomain_InnerShareable,
///                             MBReqDomain_OuterShareable, MBReqDomain_FullSystem};enumeration MBReqTypes     {MBReqTypes_Reads, MBReqTypes_Writes, MBReqTypes_All};type MemAttrHints is (
///     bits(2) attrs,  // See MemAttr_*, Cacheability attributes
///     bits(2) hints,  // See MemHint_*, Allocation hints
///     boolean transient
/// )enumeration MemType {MemType_Normal, MemType_Device};type MemoryAttributes is (
///     MemType      memtype,
/// 
...
/// )enumeration PrefetchHint {Prefetch_READ, Prefetch_WRITE, Prefetch_EXEC};SpeculativeStoreBypassBarrierToPA();SpeculativeStoreBypassBarrierToVA();type TLBRecord is (
///     Permissions       perms,
...
/// 
/// constant integer TAG_GRANULE = 1 << LOG2_TAG_GRANULE;// These two _Mem[] accessors are the hardware operations which perform single-copy atomic,
...
/// 
/// _Mem[AddressDescriptor desc, integer size, AccessDescriptor accdesc] = bits(8*size) value;// DefaultMPAMinfo
/// // ===============
...
///     return DefaultInfo;constant PARTIDtype DefaultPARTID = 0<15:0>;constant PMGtype    DefaultPMG = 0<7:0>;// GenMPAMcurEL
/// // ============
...
///             if validEL then
///                 return genMPAM(UInt(mpamel), InD, securempam);
///     return DefaultMPAMinfo(securempam);// MAP_vPARTID
/// // ===========
...
///         when EL1 return MPAM1_EL1.MPAMEN == '1';// MPAMisVirtual
/// // =============
...
///              ( el == 1 && MPAMHCR_EL2.EL1_VPMEN == '1')));// genMPAM
/// // =======
...
///         if HaveMPAMExt() && MPAMisEnabled() then
///             return genMPAM(UInt(el), InD, securempam);
///     return DefaultMPAMinfo(securempam);// genPARTID
/// // =========
...
///         return groupel;
///     return DefaultPMG;// getMPAM_PARTID
/// // ==============
...
///     return vpmw<vpme_lsb +: 16>;// BranchTo()
/// // ==========
/// 
...
///     BranchType_UNKNOWN};    // Other// Report the hint passed to BranchTo() and BranchToAddr(), for consideration when processing
/// // the next instruction.
/// Hint_Branch(BranchType hint);// Return address of the sequentially next instruction.
/// bits(N) NextInstrAddr();// Reset the External Debug registers in the Core power domain.
/// ResetExternalDebugRegisters(boolean cold_reset);// ThisInstrAddr()
/// // ===============
/// // Return address of the current instruction.
/// 
/// bits(N) ThisInstrAddr()
///     assert N == 64 || (N == 32 && UsingAArch32());
///     return _PC<N-1:0>;bits(64) _PC;array bits(64) _R[0..30];// SPSR[] - non-assignment form
/// // ============================
/// 
/// bits(32) SPSR[]
///     bits(32) result;
...
///             otherwise         Unreachable();
///     return;enumeration ArchVersion {
///     ARMv8p0
///     , ARMv8p1
///     , ARMv8p2
///     , ARMv8p3
...
///         BTypeNext = '00';// ClearEventRegister()
/// // ====================
/// // Clear the Event Register of this PE
/// 
/// ClearEventRegister()
///     EventRegister = '0';
///     return;// Clear a pending physical SError interrupt
/// ClearPendingPhysicalSError();// Clear a pending virtual SError interrupt
/// ClearPendingVirtualSError();// ConditionHolds()
/// // ================
...
///         result = !result;
/// 
///     return result;ConsumptionOfSpeculativeDataBarrier();// CurrentInstrSet()
/// // =================
/// 
...
///     return PLOfEL(PSTATE.EL);constant bits(2) EL3 = '11';
/// constant bits(2) EL2 = '10';
/// constant bits(2) EL1 = '01';
/// constant bits(2) EL0 = '00';// EL2Enabled()
/// // ============
...
/// 
/// boolean EL2Enabled()
///     return HaveEL(EL2) && (!HaveEL(EL3) || SCR_EL3.NS == '1' || IsSecureEL2Enabled());// ELFromM32()
/// // ===========
/// 
...
///     assert known;
///     return aarch32;// ELStateUsingAArch32K()
/// // ======================
/// 
...
///     return (known, aarch32);// ELUsingAArch32()
/// // ================
/// 
/// boolean ELUsingAArch32(bits(2) el)
///     return ELStateUsingAArch32(el, IsSecureBelowEL3());// ELUsingAArch32K()
/// // =================
/// 
/// (boolean,boolean) ELUsingAArch32K(bits(2) el)
///     return ELStateUsingAArch32K(el, IsSecureBelowEL3());// Terminate processing of the current instruction.
/// EndOfInstruction();// PE enters a low-power state
/// EnterLowPowerState();bits(1) EventRegister;// GetPSRFromPSTATE()
/// // ==================
...
///     return version == ARMv8p0 || boolean IMPLEMENTATION_DEFINED;// HaveAArch32EL()
/// // ===============
/// 
...
///     return boolean IMPLEMENTATION_DEFINED;// HaveELUsingSecurityState()
/// // ==========================
...
///         otherwise
///             return (HaveEL(EL3) ||
///                     (secure == boolean IMPLEMENTATION_DEFINED "Secure-only implementation"));// HaveFP16Ext()
/// // =============
...
///         return EL2;
///     else
///         return EL1;// HighestELUsingAArch32()
/// // =======================
/// // Return TRUE if configured to boot into AArch32 operation
/// 
/// boolean HighestELUsingAArch32()
///     if !HaveAnyAArch32() then return FALSE;
///     return boolean IMPLEMENTATION_DEFINED;       // e.g. CFG32SIGNAL == HIGH// Provides a hint to close any gathering occurring within the micro-architecture.
/// Hint_DGH();// Provides a hint that the task performed by a thread is of low
/// // importance so that it could yield to improve overall performance.
/// Hint_Yield();// IllegalExceptionReturn()
/// // ========================
/// 
...
///     return FALSE;enumeration InstrSet {InstrSet_A64, InstrSet_A32, InstrSet_T32};InstructionSynchronizationBarrier();// InterruptPending()
/// // ==================
...
///     return pending_physical_interrupt || pending_virtual_interrupt;// IsEventRegisterSet()
/// // ====================
/// // Return TRUE if the Event Register of this PE is set, and FALSE otherwise
/// 
/// boolean IsEventRegisterSet()
///     return EventRegister == '1';// IsHighestEL()
/// // =============
/// // Returns TRUE if given exception level is the highest exception level implemented
/// 
/// boolean IsHighestEL(bits(2) el)
///     return HighestEL() == el;// IsInHost()
/// // ==========
/// 
/// boolean IsInHost()
///     return ELIsInHost(PSTATE.EL);// Return TRUE if a physical SError interrupt is pending
/// boolean IsPhysicalSErrorPending();// IsSecure()
/// // ==========
...
///         return TRUE;
///     return IsSecureBelowEL3();// IsSecureBelowEL3()
/// // ==================
...
///         return boolean IMPLEMENTATION_DEFINED "Secure-only implementation";// IsSecureEL2Enabled()
/// // ====================
...
///             return IsSecure();
///     else
///         return FALSE;// Return TRUE if a virtual SError interrupt is pending
/// boolean IsVirtualSErrorPending();constant bits(5) M32_User    = '10000';
...
/// constant bits(5) M32_System  = '11111';// PLOfEL()
/// // ========
/// 
...
///         when EL2  return PL2;
///         when EL1  return PL1;
///         when EL0  return PL0;ProcState PSTATE;enumeration PrivilegeLevel {PL3, PL2, PL1, PL0};type ProcState is (
...
///         return '00000000';
///     else
///         return it;type SCRType;// SCR_GEN[]
/// // =========
/// 
/// SCRType SCR_GEN[]
...
///     return r;// Signal an event to all PEs in a multiprocessor system to set their Event Registers.
/// // When a PE executes the SEV instruction, it causes this function to be executed
/// SendEvent();// SendEventLocal()
/// // ================
...
///     return;boolean ShouldAdvanceIT;SpeculationBarrier();SynchronizeContext();// Implements the error synchronization event.
/// SynchronizeErrors();// Take any pending unmasked physical SError interrupt
/// TakeUnmaskedPhysicalSErrorInterrupts(boolean iesb_req);// Take any pending unmasked physical SError interrupt or unmasked virtual SError
/// // interrupt.
/// TakeUnmaskedSErrorInterrupts();bits(32) ThisInstr();integer ThisInstrLength();Unreachable()
///     assert FALSE;// UsingAArch32()
/// // ==============
...
///             return Constraint_FALSE;// ConstrainUnpredictableBits()
/// // ============================
/// 
...
///     else
///         return (c, bits(width) UNKNOWN);    // bits result not used// ConstrainUnpredictableBool()
/// // ============================
/// 
...
///     return (c == Constraint_TRUE);// ConstrainUnpredictableInteger()
/// // ===============================
/// 
...
///     else
///         return (c, integer UNKNOWN);    // integer result not usedenumeration Constraint    {// General
...
///                            // IPA too large
///                            Constraint_FORCE, Constraint_FORCENOSLCHECK};enumeration Unpredictable {// Writeback/transfer register overlap (load)
...
///                            Unpredictable_CLEARERRITEZERO};// AdvSIMDExpandImm()
/// // ==================
/// 
...
///     return (result<N-1:0>, saturated);// UnsignedRSqrtEstimate()
/// // =======================
/// 
...
/// 
///     return result;// UnsignedRecipEstimate()
/// // =======================
/// 
...
///     return (EDSCR.TFO == '0' || !niden);// TraceAllowed()
/// // ==============
...
///         return TRE_bit == '1';
///     else
///         return (!IsSecure() || ExternalSecureNoninvasiveDebugEnabled());// TraceContextIDR2()
/// // ==================
/// 
/// boolean TraceContextIDR2()
///     if !TraceAllowed()|| !HaveEL(EL2) then return FALSE;
///     return (!SelfHostedTraceEnabled() || TRFCR_EL2.CX == '1');// Memory barrier instruction that preserves the relative order of memory accesses to System
/// // registers due to trace operations and other memory accesses to the same registers
/// TraceSynchronizationBarrier();// TraceTimeStamp()
/// // ================
/// 
...
///             otherwise  Unreachable();              // ConstrainUnpredictableBits removes this case
///     else
///         return TimeStamp_CoreSight;// CombineS1S2AttrHints()
/// // ======================
...
/// 
///     return result;// CombineS1S2Device()
/// // ===================
...
/// 
///     return result;// LongConvertAttrsHints()
/// // =======================
...
///             memattrs.outershareable = TRUE;
/// 
///     return memattrs;// S1CacheDisabled()
/// // =================
/// 
...
/// 
///     return MemAttrDefaults(memattrs);// S2CacheDisabled()
/// // =================
/// 
...
///     return disable == '1';// S2ConvertAttrsHints()
/// // =====================
...
///     result.transient = FALSE;
/// 
///     return result;// ShortConvertAttrsHints()
/// // ========================
...
///     return S1TranslationRegime(PSTATE.EL);// VAMax()
/// // =======
...
/// ```
#[box_to_static_reference]
pub(super) fn shared() -> &'static [IrStatement] {
    [exception("shared")].into()
}
