...
use crate::{
    abstract_syntax_tree::{
        Ast, AstFunctionId, AstFunctionVersion, AstOptimizationKind, AstValue, AstValueType,
        AstVariable, AstVariableId, PrintWithConfig, Wrapped,
        optimize::ir_analyzation::convert::resolve_constant,
    },
