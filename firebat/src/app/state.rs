...
pub(super) struct FirebatState {
    ...
    /// Current AST value flowing through the async pipeline.
    pub(super) pipeline_current_ast: Option<Arc<Ast>>,
    /// Total optimization steps in the expanded async pipeline.
    pub(super) pipeline_total_steps: usize,
...
impl FirebatState {
    ...
    fn reset_pipeline_state(&mut self) {
        ...
        self.pending_optimize_queue.clear();
        self.pipeline_current_ast = None;
